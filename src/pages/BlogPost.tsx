...
const posts: Record<string, BlogPostData> = {
  ...
  'demenagement-entreprise-paris-checklist': {
    ...
    content: `
      ...
      <p>L’informatique est l’un des points les plus sensibles d’un déménagement de bureaux. Marne Transdem peut <a href="/transfert-informatique-paris">transporter le matériel informatique</a> avec précaution, mais la déconnexion, la sauvegarde, la remise en réseau, la téléphonie, les serveurs, les accès internet et les configurations doivent être préparés avec votre prestataire informatique ou votre responsable IT.</p>
