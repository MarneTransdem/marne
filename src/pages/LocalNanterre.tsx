...
const LocalNanterre: React.FC = () => {
  const path = "/demenagement-nanterre";
  ...
  return (
    <div className="bg-white text-slate-900 overflow-x-hidden italic font-display uppercase italic underline decoration-accent/20 underline-offset-8">
      <SEO 
        title="Déménagement Nanterre | Marne Transdem"
        description="Préparez votre déménagement à Nanterre avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
            ...
            { name: "Déménagement Nanterre", item: path }
          ])
        ]}
      />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            <nav className="flex items-center gap-2 mb-8 text-[10px] font-black uppercase tracking-widest text-slate-400">
              ...
              <span>/</span>
              <span className="text-accent underline decoration-accent/20 underline-offset-4 font-black uppercase">Nanterre</span>
            </nav>
            ...
            <p className="text-lg md:text-2xl text-slate-500 mb-12 leading-relaxed font-light max-w-2xl italic font-display lowercase first-letter:uppercase">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Nanterre, avec une organisation adaptée aux appartements, maisons, résidences, bureaux, commerces, zones d’activité et contraintes d’accès de l’ouest francilien.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            <div className="space-y-8 font-display">
              <div className="inline-block px-4 py-1.5 bg-brand-900/5 rounded-full">
                <span className="text-[10px] font-black uppercase tracking-widest text-brand-900 italic">Ville Majeure des Hauts-de-Seine</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display">
                Votre déménagement à Nanterre
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900">
                <p>
                  Ville majeure des <span className="font-bold text-slate-700">Hauts-de-Seine</span>, Nanterre est un pôle urbain et économique de premier plan à l'ouest de <span className="font-bold text-slate-700">Paris</span>. Marne Transdem accompagne les <span className="font-bold text-slate-700">particuliers</span> et les <span className="font-bold text-slate-700">entreprises</span> dans leurs projets de déménagement, qu'il s'agisse de transferts locaux ou de projets longue distance.
                </p>
                <p>
      ...
      <section className="py-24 bg-brand-900 text-white relative overflow-hidden font-display">
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-white text-center font-display">
          <div className="max-w-3xl mb-20 mx-auto font-display">
            <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white font-display uppercase italic">Organisation & Expertise Locale</h2>
            <p className="text-slate-400 text-lg font-light leading-relaxed italic font-display text-white">
              Une ville étendue aux profils variés nécessite une analyse technique précise de chaque projet de mouvement.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white text-left font-display">
            {[
              { 
                title: "Quartiers Hétérogènes", 
                desc: "Des zones pavillonnaires aux résidences denses, nous adaptons le matériel et l'équipe au type de bâtiment.",
                icon: Home 
              },
              { 
                title: "Environnement Tertiaire", 
                desc: "Expertise en transfert de bureaux et administrations près de La Défense avec gestion d'archives.",
                icon: ShieldCheck 
              },
              { 
                title: "Mixité Logistique", 
                desc: "Capacité à gérer de gros volumes familiaux en maison comme des déménagements de studios en résidence.",
                icon: Building2 
              },
              { 
                title: "Protection Intégrale", 
                desc: "Emballage soigné pour le mobilier, le matériel informatique professionnel et les objets fragiles.",
                icon: Box 
              },
              { 
                title: "Accès & Manutention", 
                desc: "Analyse des étages, ascenseurs, parkings, caves et besoin éventuel de monte-meuble extérieur.",
                icon: Zap 
              },
              { 
                title: "Anticipation Urbaine", 
                desc: "Gestion des zones de stationnement et des accès depuis la rue pour minimiser les interruptions de flux.",
                icon: MapPin 
              }
            ].map((item, i) => (
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 text-center font-display">
          <div className="text-center mb-16 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">Nos services à Nanterre</h2>
            <p className="text-slate-500 font-light text-lg italic font-display">Des prestations sur-mesure pour accompagner votre mobilité dans les Hauts-de-Seine.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 font-display text-left">
            {[
              ...
              { title: "Déménagement Entreprises", path: "/demenagement-entreprises-paris", desc: "Bureaux, administrations, cabinets, commerces et agences." },
              ...
              { title: "Formules de déménagement", path: "/formules-demenagement", desc: "Économique, Standard ou Luxe selon vos besoins de service." },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            ...
            <div className="space-y-8 order-1 lg:order-2 font-display text-slate-900">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display italic uppercase">
                Déménagement de particuliers à Nanterre
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900">
                <p>
                  Marne Transdem accompagne les particuliers pour les déménagements de maisons, d'appartements, de studios et de résidences à Nanterre. Que vous quittiez Nanterre vers Paris ou qu'il s'agisse d'un emménagement depuis une autre ville (Île-de-France ou province), nous personnalisons nos interventions.
                </p>
                <p>
                  Notre équipe prend en charge le <span className="font-bold text-slate-700">tri</span>, la <span className="font-bold text-slate-700">préparation des cartons</span>, la <span className="font-bold text-slate-700">protection du mobilier</span> et le soin des <span className="font-bold text-slate-700">objets fragiles</span>. En fonction des <span className="font-bold text-slate-700">accès</span> (<span className="font-bold text-slate-700">ascenseur</span>, <span className="font-bold text-slate-700">cave</span>, <span className="font-bold text-slate-700">garage</span>, <span className="font-bold text-slate-700">parking</span>) et du <span className="font-bold text-slate-700">volume estimé</span>, vous choisissez la <span className="font-bold text-slate-700">formule</span> idéale. Un <span className="font-bold text-slate-700">garde-meuble</span> peut ortienter votre projet en cas de décalage de dates.
                </p>
              </div>
              <Link 
                to="/demande-de-devis" 
      ...
      <section className="py-24 font-display text-slate-900 font-display underline decoration-accent/20 underline-offset-8">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            <div className="space-y-8 font-display text-slate-900">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display italic uppercase">
                Déménagement d’entreprises à Nanterre
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900 font-display">
                <p>
                  Nanterre accueille de nombreux pôles économiques et administratifs. Nous accompagnons les professionnels pour leurs transferts de bureaux, sièges, administrations, commerces et agences. De la gestion du <span className="font-bold text-slate-700">mobilier professionnel</span> aux <span className="font-bold text-slate-700">archives</span> et au <span className="font-bold text-slate-700">matériel informatique</span>, nous assurons une logistique rigoureuse pour garantir la <span className="font-bold text-slate-700">continuité d'activité</span>.
                </p>
                <p>
                  Notre proximité avec <span className="font-bold text-slate-700">La Défense</span>, <span className="font-bold text-slate-700">Courbevoie</span>, <span className="font-bold text-slate-700">Puteaux</span>, <span className="font-bold text-slate-700">Rueil-Malmaison</span> et <span className="font-bold text-slate-700">Suresnes</span> nous permet d'organiser des transferts fluides avec un <span className="font-bold text-slate-700">planning</span> d'intervention optimisé. Nous gérons les accès spécifiques (quais, parkings) et proposons du <span className="font-bold text-slate-700">stockage temporaire</span> si nécessaire.
                </p>
              </div>
              <Link 
              ...
              >
                ...
                <ArrowRight size={22} className="font-display decoration-accent/20 animate-pulse" />
              </Link>
            </div>
            <div className="relative font-display">
      ...
      <section className="py-24 bg-slate-50 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 font-display text-slate-900">
            ...
            <p className="text-slate-500 text-lg font-light italic font-display">Trois niveaux d'accompagnement pour correspondre à votre budget et vos attentes opérationnelles.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-900 font-display">
            {[
              { 
                name: "Économique", 
                desc: "Déménagement efficace : vous préparez vos cartons, nous prenons en charge la manutention et le transport." 
              },
              { 
                name: "Standard", 
              ...
              { 
                name: "Luxe", 
                desc: "Sérénité totale : nous déléguons la majorité de la préparation, de l'emballage et de l'organisation pour un service premium." 
              }
            ].map((f, i) => (
        ...
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="bg-brand-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl font-display">
            ...
            <div className="max-w-4xl relative z-10 text-white font-display">
              <h2 className="text-3xl md:text-5xl font-black mb-10 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white font-display uppercase italic">Volume, accès et monte-meuble à Nanterre</h2>
              <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed mb-12 italic font-display text-white">
                <p>
                  Certains projets à Nanterre imposent une étude logistique attentive. L'étendue de la ville, entre <span className="text-white font-medium">maisons du Mont-Valérien</span>, <span className="text-white font-medium">résidences de standing</span> et <span className="text-white font-medium">immeubles modernes</span>, exige de calibrer les moyens humains et matériels.
                </p>
                <p>
              ...
              >
                ...
                <ArrowRight size={22} className="font-display decoration-accent/10 sm:scale-100" />
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* 10. Notre méthode */}
      <section className="py-24 font-display text-slate-900 underline decoration-accent/10 underline-offset-4">
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="text-center mb-20 font-display text-slate-900">
            ...
            <p className="text-slate-500 text-lg font-light italic font-display">Un processus structuré pour préparer votre déménagement à Nanterre avec une sérénité maximale.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 font-display">
            {[
              { title: "Analyse de votre projet", icon: ClipboardCheck, desc: "Définition précise de vos besoins, dates et caractéristiques de Nanterre." },
              ...
              { title: "Réalisation du mouvement", icon: Truck, desc: "Intervention soignée par nos techniciens déménageurs experts." }
            ].map((step, i) => (
      ...
      {/* 11. Secteurs proches */}
      <section className="py-24 border-t border-slate-100 bg-slate-50 font-display text-slate-900 text-center uppercase">
        <div className="container mx-auto px-4 md:px-6 font-display">
      ...
      <section className="py-24 bg-accent relative overflow-hidden font-display text-brand-900 text-center">
        <div className="container mx-auto px-4 md:px-6 relative z-10 font-display text-brand-900">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight font-display italic underline decoration-brand-900/20 underline-offset-8 uppercase italic font-display">Vous préparez un déménagement à Nanterre ?</h2>
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl font-display text-slate-900 font-display decoration-accent/10 underline-offset-4">
          <div className="text-center mb-16 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">FAQ Nanterre</h2>
            <p className="text-slate-500 font-light italic font-display">Nos réponses pour organiser votre projet logistique sereinement dans les Hauts-de-Seine.</p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 font-display">
            ...
            <div className="space-y-4 font-display">
              ...
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display">
                <li><Link to="/demenagement-particuliers-paris" className="text-slate-500 hover:text-accent transition-colors font-display">Particuliers</Link></li>
                <li><Link to="/demenagement-entreprises-paris" className="text-slate-500 hover:text-accent transition-colors font-display">Entreprises</Link></li>
                <li><Link to="/location-monte-meuble-paris" className="text-slate-500 hover:text-accent transition-colors font-display">Monte-meuble</Link></li>
              </ul>
            </div>
            <div className="space-y-4 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic uppercase">Solutions</h5>
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display">
                <li><Link to="/garde-meuble-paris" className="text-slate-500 hover:text-accent transition-colors underline-offset-2">Garde-meuble</Link></li>
