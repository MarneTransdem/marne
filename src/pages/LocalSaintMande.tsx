          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed font-light">
                <p>
                  Commune résidentielle d'exception limitrophe de <span className="font-bold text-slate-700">Paris 12e</span> et <span className="font-bold text-slate-700">Vincennes</span>, Saint-Mandé offre un cadre de vie privilégié. Marne Transdem intervient quotidiennement dans ce secteur, ainsi qu'à <span className="font-bold text-slate-700">Paris 20e</span>, <span className="font-bold text-slate-700">Charenton-le-Pont</span> et l'ensemble du <span className="font-bold text-slate-700">Val-de-Marne</span>.
                </p>
                <p>
