...
const LongueDistanceParisStrasbourg: React.FC = () => {
  const path = "/demenagement-paris-strasbourg";
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO 
        title="Déménagement Paris Strasbourg | Marne Transdem"
        description="Organisez votre déménagement de Paris vers Strasbourg avec Marne Transdem. Volume, emballage, transport longue distance, formules adaptées et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
            ...
            { name: "Paris Strasbourg", item: path }
          ])
        ]}
      />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-[1.1] tracking-tight italic">
              Paris <span className="text-accent italic">Strasbourg</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed font-light max-w-3xl italic font-sans">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement depuis Paris ou l’Île-de-France vers Strasbourg, avec une organisation adaptée au volume, aux accès, à la distance et au niveau d’accompagnement souhaité.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/10 underline-offset-8">
                Préparer un déménagement <br/><span className="text-accent italic">de Paris vers Strasbourg</span>
              </h2>
      ...
      {/* 3. Section “Pourquoi un déménagement Paris Strasbourg demande une bonne organisation” */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
            <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 mb-6">Logistique <span className="text-accent italic tracking-tight italic">Liaison Est</span></h2>
            <p className="text-slate-500 text-lg font-light italic max-w-3xl mx-auto italic font-sans">
              Traverser la France vers l'Est nécessite une coordination rigoureuse du volume et une anticipation fine des accès au départ comme à l'arrivée.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 italic font-sans">
            {[
              { icon: Truck, t: "Trajet A4 / Est", d: "Gestion sécurisée du transport sur l'axe autoroutier de l'Est reliant la capitale à l'Alsace." },
              ...
              { icon: Calendar, t: "Suivi Planning", d: "Coordination des dates pour assurer la fluidité de votre transition vers votre nouveau logement strasbourgeois." }
            ].map((item, i) => (
      ...
      {/* 4. Nos services pour votre déménagement Paris Strasbourg */}
      <section className="py-24 font-sans italic">
        ...
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 italic">
          {[
            { t: "Particuliers", d: "Accompagnement des familles qui quittent Paris ou l’Île-de-France pour s’installer à Strasbourg.", l: "/demenagement-particuliers-paris" },
            { t: "Entreprises", d: "Organisation des transferts professionnels entre Paris, l’Île-de-France et Strasbourg.", l: "/demenagement-entreprises-paris" },
      ...
      {/* 5. Déménagement Paris Strasbourg pour les particuliers */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center italic">
            ...
            <div className="lg:w-1/2 space-y-8 order-1 lg:order-2 italic font-sans">
              ...
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs projets de mutation, rapprochement familial ou <span className="font-bold text-slate-700 tracking-tight italic">installation à Strasbourg</span> dépuis Paris ou l'Île-de-France.
                </p>
                <p>
                   Appartement, maison ou studio, nous gérons votre transport au <span className="font-bold text-slate-700 tracking-tight italic">départ vers l’est</span> avec une expertise sur la protection de vos meubles et objets fragiles. Nous intégrons vos besoins de stationnement et d'accès pour garantir une livraison sereine quel que soit votre quartier d'arrivée strasbourgeois.
                </p>
              </div>
              <Link to="/demande-de-devis" className="inline-flex items-center gap-3 bg-brand-900 text-white px-10 py-5 rounded-full font-bold hover:bg-accent hover:text-brand-900 transition-all shadow-xl italic">
                Demander mon devis Paris Strasbourg <ArrowRight size={18} />
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* 6. Déménagement Paris Strasbourg pour les entreprises */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-20 items-center italic">
             ...
             <div className="lg:w-1/2 space-y-8 italic font-sans">
               ...
               <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic">
                 <p>
                   Marne Transdem accompagne les entreprises, bureaux et agences dans leur <span className="font-bold text-brand-900 italic tracking-tight">transfert professionnel</span> de Paris ou l'Île-de-France vers Strasbourg.
                 </p>
                 <p>
                    Nous assurons le transport rigoureux de votre mobilier de bureau, <span className="font-bold text-slate-700 tracking-tight italic font-bold">archives</span> et matériel informatique. Notre planning est coordonné pour favoriser la continuité de vos activités lors de votre délocalisation vers la capitale européenne.
                 </p>
               </div>
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic transition-all grayscale-[0%]">
             <div className="space-y-8 italic transition-all">
               <h2 className="text-3xl md:text-5xl font-black tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 transition-all h-full underline decoration-accent/20 underline-offset-4">Préparer l’arrivée <br/><span className="text-accent italic transition-all">à Strasbourg</span></h2>
               <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed italic italic transition-all italic transition-all">
                 <p>
                   L’arrivée à <span className="text-white font-bold italic tracking-tight transition-all">Strasbourg</span> doit aussi être anticipée selon les spécificités de votre adresse de destination. Qu'il s'agisse d'un appartement alsacien traditionnel à colombages ou d'un projet moderne dans la métropole, la configuration des accès conditionne notre organisation.
                 </p>
             ...
             <div className="bg-white/5 rounded-[3.5rem] p-12 lg:p-20 border border-white/10 backdrop-blur-md shadow-2xl space-y-8 italic font-sans transition-all h-full text-brand-900 bg-white">
                ...
                <p className="text-slate-500 italic font-light leading-relaxed text-sm transition-all italic">
                  Marne Transdem étudie la faisabilité technique à l'arrivée. Le besoin d'un monte-meuble sera confirmé selon les accès extérieurs et la configuration de la rue à Strasbourg selon la faisabilité.
                </p>
             </div>
          </div>
        </div>
      ...
      {/* 9. Formules adaptées à un déménagement Paris Strasbourg */}
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline underline-offset-8 decoration-accent/20 transition-all font-sans underline underline-offset-8">
          <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 transition-all font-sans">Formules Paris Strasbourg</h2>
        </div>
      ...
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center italic font-sans transition-all italic">
          ...
          <p className="text-slate-500 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed transition-all italic">
            Avant de demander un devis pour votre déménagement de Paris vers Strasbourg, utilisez notre calculateur de volume pour estimer vos meubles, cartons et objets principaux.
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans transition-all italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 text-center italic font-sans transition-all h-full italic">
            {[
              ...
              { icon: Truck, t: "Transport", d: "Transport sécurisé Paris Strasbourg." },
      ...
      <section className="py-24 bg-brand-900 relative overflow-hidden font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10 transition-all">
           ...
           <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed transition-all shadow-xl transition-all italic">
             Décrivez votre projet vers l'Est et recevez une estimation adaptée à votre volume, vos accès, votre distance et le niveau d’accompagnement souhaité.
           </p>
      ...
      <section className="py-24 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl italic font-sans transition-all">
           <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 transition-all font-sans underline underline-offset-8 italic">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-4 font-display uppercase italic tracking-tight transition-all font-sans underline decoration-accent/20 underline-offset-[12px] underline-offset-2">FAQ PARIS STRASBOURG</h2>
           </div>
...
export default LongueDistanceParisStrasbourg;
