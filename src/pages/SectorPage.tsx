        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {departmentCities.map(city => <li key={city.slug}>
              <Link to={`/demenagement-${city.slug}`} className="block rounded-xl border border-slate-200 p-4 text-brand-900 underline underline-offset-4 hover:text-amber-700">Déménagement : {city.name}</Link>
            </li>)}
          </ul>
        </div>
      </section>}
