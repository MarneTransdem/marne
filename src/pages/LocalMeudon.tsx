...
const LocalMeudon: React.FC = () => {
  const path = "/demenagement-meudon";
  ...
  return (
    <div className="bg-white text-slate-900 overflow-x-hidden">
      <SEO 
        title="Déménagement Meudon | Marne Transdem"
        description="Préparez votre déménagement à Meudon avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
            ...
            { name: "Déménagement Meudon", item: path }
          ])
        ]}
      />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 font-display">
          <div className="max-w-4xl font-display">
            <nav className="flex items-center gap-2 mb-8 text-[10px] font-black uppercase tracking-widest text-slate-400 font-display">
              ...
              <span>/</span>
              <span className="text-accent underline decoration-accent/20 underline-offset-4 font-black uppercase">Meudon</span>
            </nav>
            ...
            <p className="text-lg md:text-2xl text-slate-500 mb-12 leading-relaxed font-light max-w-2xl italic font-display">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Meudon, avec une organisation adaptée aux appartements, maisons, résidences, bureaux, commerces et contraintes d’accès du sud-ouest parisien.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            <div className="space-y-8 font-display">
              <div className="inline-block px-4 py-1.5 bg-brand-900/5 rounded-full">
                <span className="text-[10px] font-black uppercase tracking-widest text-brand-900 italic">Expertise Sud-Ouest Parisien</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display">
                Votre déménagement à Meudon
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900">
                <p>
                  Ville résidentielle et familiale emblématique des <span className="font-bold text-slate-700">Hauts-de-Seine</span>, Meudon offre un cadre de vie entre ville et forêt. Marne Transdem accompagne les <span className="font-bold text-slate-700">particuliers</span> et les <span className="font-bold text-slate-700">entreprises</span> dans leurs projets de déménagement au sein de cette commune dynamique.
                </p>
                <p>
      ...
      <section className="py-24 bg-brand-900 text-white relative overflow-hidden font-display">
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-white text-center font-display">
          <div className="max-w-3xl mb-20 mx-auto font-display">
            <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white font-display uppercase italic">Une préparation rigoureuse</h2>
            <p className="text-slate-400 text-lg font-light leading-relaxed italic font-display text-white">
              Déménager à Meudon nécessite d'anticiper les particularités géographiques et architecturales de la ville.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white text-left font-display">
            {[
              { 
                title: "Topographie Locale", 
                desc: "Gestion experte des rues en pente et des accès parfois sinueux typiques des collines meudonnaises.",
                icon: MapPin 
              },
              { 
                title: "Logements Familiaux", 
                desc: "Expertise pour les maisons et grands appartements avec un volume de mobilier important.",
                icon: Home 
              },
              { 
                title: "Protection & Sécurité", 
                desc: "Emballages haute protection pour vos meubles précieux, objets fragiles et effets personnels.",
                icon: ShieldCheck 
              },
              { 
                title: "Étude des Accès", 
                desc: "Anticipation des halls, parkings, ascenseurs et escaliers pour une fluidité maximale le jour J.",
                icon: Ruler 
              },
              { 
                title: "Monte-meuble Adapté", 
                desc: "Utilisation possible d'un monte-meuble selon la configuration de l'immeuble et la faisabilité.",
                icon: Zap 
              },
              { 
                title: "Solutions de Stockage", 
                desc: "Garde-meuble sécurisé pour vos besoins de transition, travaux ou stockage temporaire.",
                icon: Package 
              }
            ].map((item, i) => (
              <div key={i} className="bg-white/5 border border-white/10 p-10 rounded-[3rem] backdrop-blur-sm group hover:border-accent transition-all text-white font-display">
                ...
                <h3 className="text-xl font-bold mb-4 text-white group-hover:text-accent transition-colors font-display italic uppercase font-display">{item.title}</h3>
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 text-center font-display">
          <div className="text-center mb-16 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">Nos prestations à Meudon</h2>
            <p className="text-slate-500 font-light text-lg italic font-display">Des services sur-mesure pour votre projet de déménagement dans les Hauts-de-Seine.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            ...
            <div className="space-y-8 order-1 lg:order-2 font-display text-slate-900">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display italic uppercase">
                Déménagement de particuliers à Meudon
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs déménagements à Meudon. Que vous quittiez un appartement, une maison de ville ou une résidence, nous adaptons nos moyens au volume de vos meubles et aux contraintes de votre adresse.
                </p>
                <p>
                  Nous gérons la <span className="font-bold text-slate-700">préparation des cartons</span>, la <span className="font-bold text-slate-700">protection des meubles</span> et le transport sécurisé de vos <span className="font-bold text-slate-700">objets fragiles</span>. En fonction des <span className="font-bold text-slate-700">accès</span> (<span className="font-bold text-slate-700">ascenseur</span>, <span className="font-bold text-slate-700">escalier</span>, <span className="font-bold text-slate-700">cave</span>, <span className="font-bold text-slate-700">garage</span>, <span className="font-bold text-slate-700">parking</span>) et de votre budget, nous vous conseillons sur la <span className="font-bold text-slate-700">formule</span> la plus pertinente pour votre projet à Meudon, vers Paris ou en longue distance.
                </p>
              </div>
              <Link 
                to="/demande-de-devis" 
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            <div className="space-y-8 font-display text-slate-900">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display italic uppercase">
                Déménagement d’entreprises à Meudon
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900 font-display">
                <p>
                  Spécialiste du <span className="font-bold text-slate-700">transfert de bureaux</span>, Marne Transdem accompagne les professionnels à Meudon. Nous intervenons pour les bureaux, entreprises, cabinets, agences, professions libérales et commerces. Nous assurons la manutention du <span className="font-bold text-slate-700">mobilier professionnel</span>, des <span className="font-bold text-slate-700">archives</span> et du <span className="font-bold text-slate-700">matériel informatique</span>.
                </p>
                <p>
                  Grâce à notre proximité avec <span className="font-bold text-slate-700">Issy-les-Moulineaux</span>, <span className="font-bold text-slate-700">Boulogne-Billancourt</span>, <span className="font-bold text-slate-700">Clamart</span> et <span className="font-bold text-slate-700">Paris 15e</span>, nous organisons votre transfert professionnel en veillant à la <span className="font-bold text-slate-700">continuité de votre activité</span>. Nous proposons également des solutions de <span className="font-bold text-slate-700">stockage temporaire</span> sécurisé si votre nouveau local n'est pas immédiatement disponible.
                </p>
              </div>
              <Link 
      ...
      <section className="py-24 bg-slate-50 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 font-display text-slate-900">
            ...
            <p className="text-slate-500 text-lg font-light italic font-display">Trois niveaux d'accompagnement pour un déménagement à Meudon sur-mesure.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-900 font-display">
            {[
              { 
                name: "Économique", 
                desc: "Simplifiez votre projet : vous préparez vos cartons, nous prenons en charge la manutention et le transport sécurisé." 
              },
              { 
                name: "Standard", 
                desc: "Le meilleur rapport confort/prix : nous nous occupons de l'emballage de vos objets fragiles et de vos meubles." 
              },
              { 
                name: "Luxe", 
                desc: "Sérénité totale : nous gérons la quasi-totalité de l'emballage, de la préparation et de la mise en place logistique." 
              }
            ].map((f, i) => (
              <div key={i} className="bg-white p-12 rounded-[2.5rem] border border-slate-200 shadow-sm hover:shadow-xl transition-all flex flex-col items-center text-center font-display">
                ...
                <h3 className="text-2xl font-black text-brand-900 mb-4 font-display uppercase italic font-display italic">{f.name}</h3>
        ...
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="bg-brand-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl font-display text-white">
            ...
            <div className="max-w-4xl relative z-10 text-white font-display">
              <h2 className="text-3xl md:text-5xl font-black mb-10 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white font-display uppercase italic">Volume, accès et monte-meuble à Meudon</h2>
              <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed mb-12 italic font-display text-white font-display">
                <p>
                  Certains déménagements à Meudon requièrent une attention logistique particulière. Le <span className="text-white font-medium">volume à déménager</span>, l'<span className="text-white font-medium">étage</span>, la configuration de l'<span className="text-white font-medium">ascenseur</span>, la largeur de l'<span className="text-white font-medium">escalier</span>, ou encore l'accès via le <span className="text-white font-medium">hall d'immeuble</span> ou la <span className="text-white font-medium">rue</span> sont des éléments clés.
                </p>
                <p>
                  Si les accès intérieurs sont limités ou pour vos <span className="text-white font-medium">meubles volumineux</span> et <span className="text-white font-medium">objets fragiles</span>, un <span className="text-white font-medium">monte-meuble</span> peut être envisagé. Sa mise en place dépend de la faisabilité technique à l'adresse concernée. Nous étudions chaque situation pour garantir la sécurité de vos biens et de votre logement.
                </p>
              </div>
              <Link 
        ...
        <div className="container mx-auto px-4 md:px-6 font-display text-slate-900">
          <div className="bg-white rounded-[3rem] shadow-xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 border border-slate-100 font-display">
            <div className="max-w-xl text-center md:text-left font-display">
              ...
              <p className="text-slate-500 font-light leading-relaxed italic mb-8 text-lg font-display text-slate-900 font-display font-display">
                Avant de demander un devis, utilisez notre calculateur de volume pour estimer vos meubles, cartons et objets principaux. Cette estimation facilitera l'organisation de votre déménagement à Meudon.
              </p>
              <Link 
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="text-center mb-20 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">Déménager à Meudon : notre méthode</h2>
            <p className="text-slate-500 text-lg font-light italic font-display">Quatre étapes pour un déménagement maîtrisé et serein.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 font-display">
            {[
              { title: "Analyse de votre projet", icon: ClipboardCheck, desc: "Définition de vos besoins, de vos dates et des spécificités d'accès à Meudon." },
              { title: "Évaluation volume & accès", icon: Ruler, desc: "Analyse technique pour adapter les moyens logistiques et humains nécessaires." },
              { title: "Choix formule & planning", icon: Calendar, desc: "Validation de la prestation souhaitée et planification rigoureuse de l'intervention." },
              { title: "Réalisation du mouvement", icon: Truck, desc: "Intervention soignée par nos équipes, de l'emballage au transport sécurisé." }
            ].map((step, i) => (
              <div key={i} className="text-center group font-display text-slate-900">
                ...
                <h4 className="text-xl font-bold text-brand-900 mb-4 font-display italic uppercase font-display italic">{step.title}</h4>
      ...
      <section className="py-24 border-t border-slate-100 bg-slate-50 font-display text-slate-900 text-center uppercase first-letter:uppercase">
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="text-center mb-12 font-display">
            <h2 className="text-2xl font-black text-brand-900 font-display italic uppercase underline decoration-accent/20 underline-offset-8 font-display italic">Autres secteurs à proximité</h2>
          </div>
      ...
      <section className="py-24 bg-accent relative overflow-hidden font-display text-brand-900 text-center scale-x-100">
        <div className="container mx-auto px-4 md:px-6 relative z-10 font-display text-brand-900">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight font-display italic underline decoration-brand-900/20 underline-offset-8 uppercase italic font-display">Vous préparez un déménagement à Meudon ?</h2>
          <p className="text-brand-900/70 text-lg mb-12 max-w-2xl mx-auto font-light italic font-display text-brand-900 underline decoration-black/5">
            Décrivez votre projet et recevez une estimation adaptée à votre volume, vos accès et le niveau d’accompagnement souhaité par Marne Transdem.
          </p>
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl font-display text-slate-900">
          <div className="text-center mb-16 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">FAQ Meudon</h2>
            <p className="text-slate-500 font-light italic font-display">Vos questions sur l'organisation d'un déménagement dans les Hauts-de-Seine.</p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 font-display">
            <div className="space-y-4 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic underline-offset-2">Expertise</h5>
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display">
                ...
                <li><Link to="/formules-demenagement" className="text-slate-500 hover:text-accent transition-colors italic">Nos formules</Link></li>
              </ul>
            </div>
            <div className="space-y-4 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic uppercase">Solutions</h5>
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display">
                <li><Link to="/demenagement-particuliers-paris" className="text-slate-500 hover:text-accent transition-colors underline decoration-accent/10">Particuliers</Link></li>
                <li><Link to="/demenagement-entreprises-paris" className="text-slate-500 hover:text-accent transition-colors underline decoration-accent/10">Entreprises</Link></li>
                <li><Link to="/location-monte-meuble-paris" className="text-slate-500 hover:text-accent transition-colors italic">Monte-meuble</Link></li>
              </ul>
            </div>
            <div className="space-y-4 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic uppercase">Logistique</h5>
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display">
                <li><Link to="/garde-meuble-paris" className="text-slate-500 hover:text-accent transition-colors underline-offset-4 underline decoration-accent/10">Garde-meuble</Link></li>
            ...
            <div className="space-y-4 col-span-2 font-display">
              ...
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display uppercase font-bold decoration-accent/10">
                <li><Link to="/contact" className="text-slate-500 hover:text-accent transition-colors italic">Nous contacter</Link></li>
                <li className="pt-2 font-display italic tracking-widest">
                    <Link to="/demenagement-hauts-de-seine" className="text-slate-400 hover:text-accent text-[11px] uppercase tracking-widest font-black transition-colors font-display italic">Déménagement Hauts-de-Seine</Link>
                </li>
              </ul>
            </div>
          </div>
