...
const LongueDistanceParisLyon: React.FC = () => {
  const path = "/demenagement-paris-lyon";
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO 
        title="Déménagement Paris Lyon | Marne Transdem"
        description="Organisez votre déménagement de Paris vers Lyon avec Marne Transdem. Volume, emballage, transport longue distance, formules adaptées et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-[1.1] tracking-tight italic">
              Paris <span className="text-accent italic">Lyon</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed font-light max-w-3xl italic font-sans">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement depuis Paris ou l’Île-de-France vers Lyon, avec une organisation adaptée à la distance.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/10 underline-offset-8">
                Préparer un déménagement <br/><span className="text-accent italic">de Paris vers Lyon</span>
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic">
                <p>
                  Un déménagement entre Paris et Lyon demande une organisation précise. Marne Transdem accompagne votre <span className="font-bold text-brand-900 italic tracking-tight">départ depuis Paris</span> ou l’Île-de-France pour une installation sereine à <span className="font-bold text-brand-900 italic tracking-tight italic">Lyon</span>.
                </p>
                <p>
            ...
            <div className="relative rounded-[3rem] overflow-hidden shadow-2xl grayscale-[20%] transition-all h-full aspect-square">
               <img src="/images/demenagement-longue-distance-camion.jpg" alt="Paris Lyon Transport" width="800" height="800" loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>

      {/* 3. Section “Pourquoi un déménagement Paris Lyon demande une bonne organisation” */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
            <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 mb-6">Logistique <span className="text-accent italic tracking-tight italic">Grand Axe</span></h2>
            <p className="text-slate-500 text-lg font-light italic max-w-3xl mx-auto italic font-sans italic">
              La coordination du planning et la protection des biens sont les piliers de notre accompagnement longue distance entre la capitale et Lyon.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 italic font-sans">
            {[
              { icon: Truck, t: "Distance & Trajet", d: "Optimisation de l'acheminement sur l'axe Paris-Lyon avec une planification rigoureuse du temps de route." },
              { icon: Package, t: "Protection Renforcée", d: "Emballage spécifique pour les meubles et objets fragiles afin de sécuriser le transport sur 450km." },
              { icon: Ruler, t: "Accès & Étages", d: "Anticipation des contraintes au départ (Paris/IDF) et à l'arrivée (Lyon) pour une manutention fluide." },
              ...
              { icon: Briefcase, t: "Mutation Pro", d: "Solution pour salariés et entreprises transférant leurs activités ou collaborateurs vers la métropole lyonnaise." },
      ...
      {/* 4. Nos services pour votre déménagement Paris Lyon */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
           <h2 className="text-3xl md:text-5xl font-black text-brand-900 uppercase italic tracking-tight underline italic">Prestations <span className="text-accent italic tracking-tight italic underline italic underline-offset-4">longue distance</span></h2>
        </div>
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 italic">
          {[
            { t: "Particuliers", d: "Accompagnement des familles quittant l’Île-de-France pour s’installer à Lyon.", l: "/demenagement-particuliers-paris" },
            { t: "Entreprises", d: "Transferts professionnels et bureaux de Paris vers la métropole lyonnaise.", l: "/demenagement-entreprises-paris" },
      ...
      {/* 5. Déménagement Paris Lyon pour les particuliers */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center italic">
            <div className="lg:w-1/2 rounded-[3.5rem] overflow-hidden shadow-2xl relative order-2 lg:order-1 grayscale-[10%]">
               <img src="/images/demenagement-maison-appartement-particulier.jpg" alt="Particulier Paris Lyon" width="800" height="600" loading="lazy" decoding="async" className="w-full h-full object-cover italic transition-all h-full grayscale-[10%]" />
            </div>
            <div className="lg:w-1/2 space-y-8 order-1 lg:order-2 italic font-sans italic">
              ...
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic italic">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs projets de mutation, changement de résidence ou <span className="font-bold text-slate-700 tracking-tight italic tracking-tight">installation à Lyon</span>.
                </p>
                <p>
                   Qu'il s'agisse d'un <span className="font-bold text-slate-700 tracking-tight italic text-slate-700">appartement</span> dans Lyon Intramuros ou d'une <span className="font-bold text-slate-700 tracking-tight italic">maison</span> en périphérie lyonnaise, nous gérons le transport depuis l’Île-de-France avec une attention particulière aux <span className="font-bold text-slate-700 tracking-tight italic font-bold">meubles</span> et objets fragiles.
                </p>
              </div>
              <Link to="/demande-de-devis" className="inline-flex items-center gap-3 bg-brand-900 text-white px-10 py-5 rounded-full font-bold hover:bg-accent hover:text-brand-900 transition-all shadow-xl italic tracking-tight italic h-full transition-all italic">
                Demander mon devis Paris Lyon <ArrowRight size={18} />
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* 6. Déménagement Paris Lyon pour les entreprises */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-20 items-center italic">
             <div className="lg:w-1/2 rounded-[3.5rem] overflow-hidden shadow-2xl relative grayscale-[10%] italic transition-all h-full transition-all italic grayscale-[10%]">
                <img src="/images/transfert-bureaux-entreprise-paris.jpg" alt="Entreprise Paris Lyon" width="800" height="600" loading="lazy" decoding="async" className="w-full h-full object-cover italic transition-all h-full" />
             </div>
             <div className="lg:w-1/2 space-y-8 italic font-sans italic italic">
               <h2 className="text-3xl md:text-4xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 italic transition-all italic h-full underline decoration-accent/20 underline-offset-4 italic">Transferts d'entreprise</h2>
               <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic italic italic">
                 <p>
                   Notre expertise s'adresse aux bureaux, agences et cabinets souhaitant opérer un <span className="font-bold text-brand-900 italic tracking-tight">transfert professionnel</span> entre Paris/IDF et Lyon.
                 </p>
                 <p>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic font-sans italic underline underline-offset-8 italic underline animation-pulse transition-all italic">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic transition-all italic grayscale-[0%] transition-all">
             <div className="space-y-8 italic transition-all transition-all italic transition-all">
               ...
               <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed italic italic italic italic transition-all italic italic transition-all italic transition-all italic transition-all italic">
                 <p>
                   L’arrivée à <span className="text-white font-bold italic tracking-tight transition-all">Lyon</span> doit être anticipée selon la configuration de votre nouvelle adresse. Chaque projet fait l'objet d'une étude selon le type de logement.
                 </p>
                 <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 italic font-sans italic italic transition-all italic transition-all italic transition-all transition-all italic transition-all">
                    {[
                      "Appartement ou maison", "Étage & Ascenseur", "Accès Cage d'Escalier", "Stationnement Rue", "Accès Meubles Volumineux", "Option Monte-meuble"
                    ].map((item, i) => (
             ...
             <div className="bg-white/5 rounded-[3.5rem] p-12 lg:p-20 border border-white/10 backdrop-blur-md shadow-2xl space-y-8 italic font-sans italic transition-all italic transition-all transition-all italic transition-all italic font-sans italic transition-all h-full">
                ...
                <p className="text-slate-300 italic font-light italic leading-relaxed text-sm italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
                  Marne Transdem accompagne votre installation lyonnaise avec rigueur. La faisabilité d'un monte-meuble dépendra de la configuration technique constatée à l'arrivée (façade, rue, accès).
                </p>
             </div>
          </div>
        </div>
      ...
      {/* 9. Formules adaptées à un déménagement Paris Lyon */}
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline underline-offset-8 decoration-accent/20 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
          <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 italic transition-all italic font-sans italic transition-all italic transition-all">Formules Paris Lyon</h2>
        </div>
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
          {[
            { n: "Économique", d: "Manutention et transport sécurisé sur 450km. Vous assurez la préparation intégrale de vos cartons." },
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all italic font-sans italic transition-all italic transition-all italic">
           <div className="max-w-4xl mx-auto space-y-12 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all">
             ...
             <p className="text-slate-500 text-lg font-light leading-relaxed italic italic italic italic italic transition-all italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
                Le devis pour votre déménagement <span className="font-bold text-brand-900 italic tracking-tight">Paris Lyon</span> dépend notamment de l'étude rigoureuse du volume, des adresses et de la formule choisie.
             </p>
      ...
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          ...
          <p className="text-slate-500 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all transition-all">
            Avant de solliciter votre devis personnalisé Paris Lyon, utilisez notre calculateur de volume. Cette estimation indicative sera affinée selon les accès et les caractéristiques de votre projet.
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 text-center italic font-sans transition-all italic transition-all transition-all italic h-full transition-all">
            {[
              ...
              { icon: Truck, t: "Transport", d: "Acheminement sécurisé vers Lyon." },
              ...
              <div key={i} className="space-y-6 group italic font-sans italic italic transition-all italic transition-all h-full italic transition-all">
                 ...
                 <div className="px-2 italic transition-all">
                    <h4 className="font-bold text-brand-900 mb-2 text-xs italic tracking-tight transition-all font-sans uppercase italic italic italic transition-all">{step.t}</h4>
      ...
      <section className="py-24 bg-accent relative overflow-hidden font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10 italic transition-all">
           <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-8 font-display uppercase tracking-tight italic leading-tight italic transition-all italic h-full">VOTRE PROJET <br/><span className="text-white italic tracking-tight italic italic border-b-4 border-brand-900 shadow-sm transition-all italic">PARIS LYON ?</span></h2>
           <p className="text-brand-900/70 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
           ...
           <div className="flex flex-col sm:flex-row gap-6 justify-center items-center italic italic transition-all italic transition-all italic transition-all italic shadow-2xl transition-all transition-all italic transition-all italic transition-all italic shadow-xl transition-all">
             <Link to="/demande-de-devis" className="bg-brand-900 text-white px-10 py-5 rounded-full font-bold text-lg hover:shadow-2xl flex items-center justify-center gap-3 transition-all min-w-[280px] italic shadow-xl transition-all transition-all italic transition-all italic transition-all">
               Demander mon devis gratuit
             </Link>
             <a href={`tel:${CONTACT.phone.replace(/\s/g, '')}`} className="bg-white text-brand-900 px-10 py-5 rounded-full font-bold text-lg hover:bg-slate-50 shadow-md flex items-center justify-center gap-3 transition-all min-w-[280px] italic shadow-md transition-all transition-all italic transition-all italic transition-all">
                <Phone size={22} className="text-accent" />
                {CONTACT.phone}
             </a>
           </div>
        </div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-brand-900/5 rounded-full blur-[100px] pointer-events-none translate-x-[40%] translate-y-[-40%] italic transition-all italic italic transition-all italic transition-all italic shadow-2xl transition-all transition-all italic transition-all italic transition-all italic"></div>
      </section>
      ...
      <section className="py-24 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
           <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-4 font-display uppercase italic tracking-tight transition-all font-sans italic underline decoration-accent/20 underline-offset-[12px] italic transition-all">FAQ PARIS LYON</h2>
           </div>
           <div className="grid grid-cols-1 gap-8 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
             {faqs.map((faq, i) => (
               <div key={i} className="bg-slate-50 p-12 rounded-[2.5rem] border border-slate-100 group hover:border-accent transition-all shadow-sm italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic selection:bg-accent italic">
                 <h4 className="text-lg font-bold text-brand-900 mb-6 flex items-start gap-5 tracking-tight uppercase italic transition-all border-l-4 border-accent pl-6 italic italic italic transition-all italic h-full transition-all">
                 ...
                 <p className="text-slate-500 font-light leading-relaxed pl-12 italic italic italic italic italic italic transition-all italic transition-all italic transition-all underline decoration-brand-900/10 transition-all font-sans italic transition-all italic transition-all italic">
                   {faq.a}
                 </p>
               </div>
             ))}
      ...
      <section className="py-12 bg-slate-900 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
          <div className="flex flex-wrap justify-center gap-x-10 gap-y-6 text-[10px] font-black uppercase tracking-[0.25em] text-slate-500 italic pb-8 border-b border-white/5 italic italic italic transition-colors transition-all italic transition-all italic transition-all italic transition-all italic transition-all underline decoration-accent/10 transition-all font-sans italic transition-all italic transition-all italic">
            ...
            <Link to="/demenagement-longue-distance" className="hover:text-accent transition-all italic italic transition-all italic transition-all italic selection:bg-accent italic transition-all italic transition-all uppercase">Longue Distance</Link>
...
export default LongueDistanceParisLyon;
