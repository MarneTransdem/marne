...
const Contact: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <section className="py-24 relative -mt-16 z-20 dark:bg-slate-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-premium group hover:border-accent transition-all"
              >
                ...
                <div className="text-[10px] uppercase tracking-widest text-slate-400 dark:text-slate-500 font-bold mb-2">{card.title}</div>
                <div className="text-xl font-bold text-brand-900 dark:text-white mb-2">{card.value}</div>
                <div className="text-xs text-slate-400 dark:text-slate-500 font-medium">{card.sub}</div>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-12 xl:col-span-8">
              <div className="mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-6">Envoyer un message</h2>
              ...
              {formState === 'success' ? (
                ...
                >
                  <div className="w-20 h-20 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg shadow-green-200 dark:shadow-green-900/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        name="name"
                        required
                        className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl px-6 py-4 outline-none focus:border-accent focus:bg-white dark:focus:bg-slate-900 transition-all font-medium text-brand-900 dark:text-white" 
                        placeholder="Jean Dupont"
                      />
                    </div>
                    <div className="space-y-2">
                      <label htmlFor="phone" className="text-[10px] font-black uppercase tracking-widest text-brand-900/60 dark:text-slate-500 ml-4">Téléphone <span className="text-accent">*</span></label>
                      <input 
                        type="tel" 
                        id="phone" 
                        name="phone"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-[10px] font-black uppercase tracking-widest text-brand-900/60 dark:text-slate-500 ml-4">Email <span className="text-accent">*</span></label>
                      <input 
                        type="email" 
                        id="email" 
                        name="email"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="subject" className="text-[10px] font-black uppercase tracking-widest text-brand-900/60 dark:text-slate-500 ml-4">Objet de la demande <span className="text-accent">*</span></label>
                      <select 
                        id="subject"
                        name="subject"
                        required
                        className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl px-6 py-4 outline-none focus:border-accent focus:bg-white dark:focus:bg-slate-900 transition-all font-medium text-brand-900 dark:text-white appearance-none"
                      >
                  ...
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-[10px] font-black uppercase tracking-widest text-brand-900/60 dark:text-slate-500 ml-4">Message <span className="text-accent">*</span></label>
                    <textarea 
                      id="message" 
                      name="message"
                      rows={6} 
                      required
                      className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl px-6 py-4 outline-none focus:border-accent focus:bg-white dark:focus:bg-slate-900 transition-all font-medium text-brand-900 dark:text-white resize-none" 
                  ...
                  <div className="flex items-start gap-4 ml-2">
                    ...
                    <label htmlFor="consent" className="text-sm text-slate-500 dark:text-slate-400 font-light">
            ...
            <div className="lg:col-span-12 xl:col-span-4">
              <div className="sticky top-32 space-y-8">
                <div className="bg-brand-900 dark:bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden transition-colors duration-300">
                  ...
                  <p className="text-slate-300 dark:text-slate-400 font-light text-sm leading-relaxed mb-10 relative z-10">
                  ...
                  <div className="space-y-6 pt-10 border-t border-white/10 dark:border-slate-800">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-white/5 dark:bg-slate-800 flex items-center justify-center text-accent">
                        <Phone size={20} />
                      </div>
                      <div>
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-[2.5rem] p-10 border border-slate-100 dark:border-slate-800">
                  <h4 className="font-bold text-brand-900 dark:text-white mb-4">Informations utiles</h4>
                  ...
                  <ul className="space-y-3">
                    {["Déménagement particuliers", "Transfert de bureaux", "Garde-meuble"].map((info, idx) => (
                      <li key={idx} className="flex items-center gap-3 text-sm font-medium text-brand-900 dark:text-slate-200">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-6">Nous intervenons à Paris et en Île-de-France</h2>
      ...
      <section className="py-24 dark:bg-slate-950">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-12 text-center tracking-tight">Pourquoi nous contacter ?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Link key={idx} to={card.path} className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 hover:border-accent transition-all hover:shadow-xl group">
                <div className="w-14 h-14 bg-slate-50 dark:bg-slate-800 text-accent rounded-2xl flex items-center justify-center mb-6 group-hover:bg-accent group-hover:text-white transition-colors">
                  <card.icon size={24} />
                </div>
                <h4 className="text-xl font-bold text-brand-900 dark:text-white mb-4">{card.title}</h4>
                <p className="text-sm text-slate-500 dark:text-slate-400 font-light leading-relaxed mb-6">{card.desc}</p>
      ...
      <section className="py-24 bg-brand-900 dark:bg-slate-950 text-white relative overflow-hidden transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl relative z-10">
          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white/5 dark:bg-slate-900/50 backdrop-blur-sm p-8 rounded-2xl border border-white/10 dark:border-slate-800 flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-300 dark:text-slate-400 font-light leading-relaxed">{faq.a}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 text-center dark:bg-slate-950">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl lg:text-5xl font-black text-brand-900 dark:text-white mb-8 tracking-tight">Un projet de déménagement à préparer ?</h2>
