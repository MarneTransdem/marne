...
const LocalRueilMalmaison: React.FC = () => {
  const path = "/demenagement-rueil-malmaison";
  ...
  return (
    <div className="bg-white text-slate-900 overflow-x-hidden">
      <SEO 
        title="Déménagement Rueil-Malmaison | Marne Transdem"
        description="Préparez votre déménagement à Rueil-Malmaison avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
            ...
            { name: "Déménagement Rueil-Malmaison", item: path }
          ])
        ]}
      />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 font-display">
          <div className="max-w-4xl font-display">
            <nav className="flex items-center gap-2 mb-8 text-[10px] font-black uppercase tracking-widest text-slate-400 font-display">
              ...
              <span>/</span>
              <span className="text-accent underline decoration-accent/20 underline-offset-4 font-black uppercase">Rueil-Malmaison</span>
            </nav>
            ...
            <p className="text-lg md:text-2xl text-slate-500 mb-12 leading-relaxed font-light max-w-2xl italic font-display">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Rueil-Malmaison, avec une organisation adaptée aux maisons, appartements, résidences, bureaux, commerces et contraintes d’accès de l’ouest francilien.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            <div className="space-y-8 font-display">
              <div className="inline-block px-4 py-1.5 bg-brand-900/5 rounded-full">
                <span className="text-[10px] font-black uppercase tracking-widest text-brand-900 italic">Prestation Premium Hauts-de-Seine</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display">
                Votre déménagement à Rueil-Malmaison
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900">
                <p>
                  Ville résidentielle et professionnelle importante des <span className="font-bold text-slate-700">Hauts-de-Seine</span>, Rueil-Malmaison offre un cadre de vie prisé à l'ouest parisien. Marne Transdem accompagne les <span className="font-bold text-slate-700">particuliers</span> et les <span className="font-bold text-slate-700">entreprises</span> dans leurs projets de déménagement locaux ou nationaux.
                </p>
                <p>
      ...
      <section className="py-24 bg-brand-900 text-white relative overflow-hidden font-display">
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-white text-center font-display">
          <div className="max-w-3xl mb-20 mx-auto font-display">
            <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white font-display uppercase italic">Expertise & Anticipation Locale</h2>
            <p className="text-slate-400 text-lg font-light leading-relaxed italic font-display text-white">
              Une ville résidentielle avec des profils de logements variés demande une analyse technique précise de chaque accès.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white text-left font-display">
            {[
              { 
                ...
                desc: "Gestion de volumes souvent plus importants en maison ou grands appartements qu'en plein Paris.",
                icon: Home 
              },
              { 
                title: "Transferts Tertiaires", 
                desc: "Expertise en bureaux et sièges d'entreprises grâce à la proximité avec La Défense et l'ouest parisien.",
                icon: ShieldCheck 
              },
              { 
                title: "Analyse des Accès", 
                desc: "Prise en compte des jardins, cours, garages, caves et halls de résidences pour une manutention fluide.",
                icon: Ruler 
              },
              { 
                title: "Protection & Sécurité", 
                desc: "Emballage technique pour le mobilier volumineux, les objets fragiles et le matériel informatique.",
                icon: Box 
              },
              { 
                title: "Monte-meuble & Levage", 
                desc: "Solution à étudier selon la configuration de la rue, de la façade et des contraintes d'étages.",
                icon: Zap 
              },
              { 
                title: "Stockage & Transition", 
                desc: "Garde-meuble disponible en cas de décalage de dates, de travaux ou pour une transition sereine.",
                icon: Package 
              }
            ].map((item, i) => (
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 text-center font-display">
          <div className="text-center mb-16 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">Nos services à Rueil-Malmaison</h2>
            <p className="text-slate-500 font-light text-lg italic font-display">Des prestations sur-mesure pour accompagner votre mobilité dans l'ouest francilien.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            ...
            <div className="space-y-8 order-1 lg:order-2 font-display text-slate-900">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display italic uppercase">
                Déménagement de particuliers à Rueil-Malmaison
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900">
                <p>
                  Marne Transdem accompagne les particuliers pour les déménagements de maisons, d'appartements, de studios et de résidences à Rueil-Malmaison. Que vous quittiez Rueil-Malmaison vers Paris ou que vous emménagiez depuis une autre ville (Île-de-France ou destination longue distance), nous adaptons chaque étape à votre situation.
                </p>
                <p>
                  Nous gérons le <span className="font-bold text-slate-700">tri</span>, la <span className="font-bold text-slate-700">préparation des cartons</span>, la <span className="font-bold text-slate-700">protection des meubles</span> et le transport des <span className="font-bold text-slate-700">objets fragiles</span>. En tenant compte des <span className="font-bold text-slate-700">accès</span> (<span className="font-bold text-slate-700">ascenseur</span>, <span className="font-bold text-slate-700">cave</span>, <span className="font-bold text-slate-700">garage</span>, <span className="font-bold text-slate-700">parking</span>) et du <span className="font-bold text-slate-700">volume</span>, vous choisissez la <span className="font-bold text-slate-700">formule</span> idéale. Un <span className="font-bold text-slate-700">garde-meuble</span> peut ortienter votre projet sereinement.
                </p>
              </div>
              <Link 
                to="/demande-de-devis" 
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center font-display">
            <div className="space-y-8 font-display text-slate-900 underline underline-offset-4 decoration-accent/20">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 font-display italic uppercase">
                Déménagement d’entreprises à Rueil-Malmaison
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display text-slate-900 font-display">
                <p>
                  Ville dynamique de l'ouest francilien, Rueil-Malmaison accueille de nombreux sièges sociaux et pôles tertiaires. Nous accompagnons les professionnels pour leurs transferts de bureaux, entreprises, cabinets, agences et commerces. De la gestion du <span className="font-bold text-slate-700">mobilier professionnel</span> aux <span className="font-bold text-slate-700">archives</span> et au <span className="font-bold text-slate-700">matériel informatique</span>, nous garantissons la <span className="font-bold text-slate-700">continuité d'activité</span>.
                </p>
                <p>
                  Notre expertise sectorielle inclut la proximité avec <span className="font-bold text-slate-700">Nanterre</span>, <span className="font-bold text-slate-700">Suresnes</span>, <span className="font-bold text-slate-700">Saint-Cloud</span>, <span className="font-bold text-slate-700">La Défense</span> et l'ouest parisien. Nous gérons les accès logistiques (quais, parkings) et proposons du <span className="font-bold text-slate-700">stockage temporaire</span> si nécessaire pour votre mobilier de bureau.
                </p>
              </div>
              <Link 
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-900 font-display">
            {[
              { 
                name: "Économique", 
                desc: "Déménagement efficace : vous préparez vos cartons, Marne Transdem assure la manutention et le transport." 
              },
              { 
                name: "Standard", 
                desc: "Un équilibre sérénité : nous emballons vos objets fragiles et gérons le mobilier pour une prestation équilibrée." 
              },
              { 
                name: "Luxe", 
                desc: "Sérénité intégrale : nous déléguons la majorité de la préparation, de l'emballage et de l'organisation pour un service premium." 
              }
            ].map((f, i) => (
        ...
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="bg-brand-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl font-display text-white">
            ...
            <div className="max-w-4xl relative z-10 text-white font-display">
              <h2 className="text-3xl md:text-5xl font-black mb-10 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white font-display uppercase italic">Volume, accès et monte-meuble à Rueil-Malmaison</h2>
              <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed mb-12 italic font-display text-white">
                <p>
                  Certains projets à Rueil-Malmaison imposent une étude logistique attentive. L'étendue de la ville, entre <span className="text-white font-medium">maisons individuelles</span>, <span className="text-white font-medium">résidences avec parcs</span> et <span className="text-white font-medium">immeubles modernes</span>, exige de calibrer les moyens humains et matériels.
                </p>
                <p>
                  Nous analysons le <span className="text-white font-medium">volume à déménager</span>, les <span className="text-white font-medium">étages</span>, la capacité des <span className="text-white font-medium">ascenseurs</span>, la largeur des <span className="text-white font-medium">escaliers</span>, l'accès au <span className="text-white font-medium">garage</span> ou au <span className="text-white font-medium">parking</span> et les spécificités des <span className="text-white font-medium">quais de livraison</span>. Pour les meubles volumineux ou les accès intérieurs restreints, un <span className="text-white font-medium">monte-meuble</span> peut être envisagé selon la faisabilité technique et le plan de <span className="text-white font-medium">stationnement</span>.
                </p>
              </div>
              <Link 
      ...
      {/* 10. Notre méthode */}
      <section className="py-24 font-display text-slate-900 underline underline-offset-4 decoration-accent/10 sm:scale-100">
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="text-center mb-20 font-display text-slate-900">
            ...
            <p className="text-slate-500 text-lg font-light italic font-display">Un processus structuré pour préparer votre déménagement à Rueil-Malmaison en toute sérénité.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 font-display">
            {[
              { title: "Analyse de votre projet", icon: ClipboardCheck, desc: "Définition de vos besoins, dates et caractéristiques de Rueil-Malmaison." },
              { title: "Évaluation volume & accès", icon: Ruler, desc: "Analyse technique pour calibrer les moyens logistiques et l'équipe." },
              { title: "Choix formule & organisation", icon: Calendar, desc: "Validation de la prestation et planification rigoureuse de l'intervention." },
              { title: "Réalisation du mouvement", icon: Truck, desc: "Intervention soignée et sécurisée par nos techniciens déménageurs." }
            ].map((step, i) => (
      ...
      <section className="py-24 border-t border-slate-100 bg-slate-50 font-display text-slate-900 text-center uppercase first-letter:uppercase">
        <div className="container mx-auto px-4 md:px-6 font-display">
          ...
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-6 text-center text-slate-500 font-display uppercase italic text-slate-900">
            ...
            <Link to="/demenagement-chatou" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display capitalize first-letter:uppercase font-bold">Déménagement Chatou</Link>
            <Link to="/demenagement-le-vesinet" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display capitalize first-letter:uppercase font-bold">Déménagement Le Vésinet</Link>
            <Link to="/demenagement-marly-le-roi" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display capitalize first-letter:uppercase font-bold">Déménagement Marly-le-Roi</Link>
            <Link to="/demenagement-le-pecq" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display capitalize first-letter:uppercase font-bold">Déménagement Le Pecq</Link>
            ...
            <Link to="/demenagement-bougival" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display capitalize first-letter:uppercase">Déménagement Bougival</Link>
            <Link to="/demenagement-la-celle-saint-cloud" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display">Déménagement La Celle-Saint-Cloud</Link>
            <Link to="/demenagement-louveciennes" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display">Déménagement Louveciennes</Link>
      ...
      <section className="py-24 bg-accent relative overflow-hidden font-display text-brand-900 text-center">
        <div className="container mx-auto px-4 md:px-6 relative z-10 font-display text-brand-900">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight font-display italic underline decoration-brand-900/20 underline-offset-8 uppercase italic font-display">Vous préparez un déménagement à Rueil-Malmaison ?</h2>
          <p className="text-brand-900/70 text-lg mb-12 max-w-2xl mx-auto font-light italic font-display font-display underline decoration-black/10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center font-display">
            <Link to="/demande-de-devis" className="bg-brand-900 text-white px-12 py-5 rounded-full font-bold text-xl hover:bg-brand-hover transition-all flex items-center gap-3 shadow-2xl font-display italic uppercase">
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl font-display text-slate-900 font-display decoration-accent/10 underline-offset-4">
          <div className="text-center mb-16 font-display text-slate-900">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">FAQ Rueil-Malmaison</h2>
            <p className="text-slate-500 font-light italic font-display">Nos réponses pour organiser votre projet logistique dans les Hauts-de-Seine.</p>
          </div>
      ...
      <section className="py-24 border-t border-slate-100 font-display bg-slate-50/50 text-slate-900 sm:scale-100">
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 font-display">
            <div className="space-y-4 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic underline-offset-2">Accès Rapide</h5>
            ...
            <div className="space-y-4 col-span-2 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic uppercase">Marne Transdem</h5>
              <ul className="space-y-2 text-sm italic font-display text-slate-900 font-display uppercase font-bold decoration-accent/10">
                <li><Link to="/contact" className="text-slate-500 hover:text-accent transition-colors">Contact</Link></li>
...
export default LocalRueilMalmaison;
