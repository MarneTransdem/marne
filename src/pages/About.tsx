  ...
  return (
    <div className="bg-white dark:bg-slate-950 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed font-light italic">
              Entreprise de déménagement basée à Paris, nous accompagnons les
              particuliers et les entreprises dans leurs transitions locales et
              nationales.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                to="/demande-de-devis"
                className="bg-accent text-brand-900 px-10 py-5 rounded-full font-bold text-lg hover:bg-accent-hover transition-all flex items-center justify-center gap-3 shadow-lg italic"
              >
              ...
              <a
                ...
                className="bg-white/10 text-white border border-white/20 px-10 py-5 rounded-full font-bold text-lg hover:bg-white hover:text-brand-900 transition-all flex items-center justify-center gap-3 italic"
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-black text-brand-900 dark:text-white mb-8 uppercase italic underline decoration-accent/10 underline-offset-8">
                Une expertise <span className="text-accent italic">francilienne</span>
              </h2>
              ...
              <div className="space-y-6 text-slate-500 dark:text-slate-400 leading-relaxed text-lg font-light italic">
                <p>
                  ...
                  , Marne Transdem offre une logistique fluide pour les
                  déménagements en Île-de-France ainsi qu&apos;au niveau
                  national.
                </p>

                <p>
                  Qu&apos;il s&apos;agisse de transférer un appartement dans le
                  Marais ou des bureaux en petite couronne, nous appliquons la
                  même rigueur et le même soin à chaque bien confié.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto max-w-5xl rounded-[2.5rem] border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 text-center shadow-sm md:p-12">
            <p className="mb-4 text-xs font-black uppercase tracking-[0.3em] text-accent">
              Notre présence en ligne
            </p>

            <h2 className="text-3xl lg:text-4xl font-black text-brand-900 dark:text-white mb-6 italic tracking-tight">
              Un site pensé pour faciliter{' '}
              <span className="text-accent underline decoration-accent/10 underline-offset-8">
                vos demandes de devis
              </span>
            </h2>

            <p className="mx-auto max-w-3xl text-lg leading-relaxed text-slate-500 dark:text-slate-400 font-light">
              Pour mieux présenter nos services de déménagement à Paris et en
              Île-de-France, Marne Transdem a confié la création de son site
              internet à{' '}
              <a
                href="https://vsw-digital.fr/etude-de-cas-marne-transdem"
                target="_blank"
                rel="noopener noreferrer"
                className="font-bold text-accent underline underline-offset-4 hover:text-accent-hover transition-colors"
              >
                VSW Digital
              </a>
              . Ce site a été pensé pour faciliter la demande de devis,
              présenter clairement nos prestations et permettre à nos clients
              d&apos;accéder rapidement aux informations utiles pour organiser
              leur déménagement.
            </p>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-6">
              Notre mission
            </h2>

            <p className="text-slate-500 dark:text-slate-400 max-w-3xl mx-auto font-light leading-relaxed text-lg">
              Notre mission est d’aider chaque client à préparer son
              déménagement avec méthode, sérénité et efficacité. Chaque projet
              est différent : volume à transporter, accès, étages, distance,
              niveau d’accompagnement souhaité, contraintes de calendrier ou
              besoins spécifiques. C’est pourquoi nous privilégions une approche
              personnalisée.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-brand-900 dark:text-white mb-4">
                  {mission.title}
                </h3>
      ...
      <section className="py-24 dark:bg-slate-950">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-6">
                Une méthode claire pour chaque déménagement
              </h2>

              <p className="text-slate-500 dark:text-slate-400 font-light leading-relaxed">
                L’objectif est d’apporter une vision claire du déroulement avant
                le jour du déménagement. Nous prenons en compte les contraintes
                propres à Paris : stationnement, étages, ascenseurs, accès
                d’immeuble, mobilier volumineux ou besoin éventuel de
                monte-meuble.
              </p>
            </div>
            ...
            <div className="space-y-8 relative before:absolute before:left-[19px] before:top-8 before:bottom-8 before:w-0.5 before:bg-slate-100 dark:before:bg-slate-800 lg:before:hidden">
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                {[
                  {
                    n: '01',
                    t: 'Échange sur votre projet',
                    d: 'Premier contact pour comprendre vos besoins.',
                  },
                  {
                    n: '02',
                    t: 'Évaluation du projet',
                    d: 'Étude du volume, des accès et des contraintes.',
                  },
                  {
                    n: '03',
                    t: 'Choix de la formule',
                    d: "Organisation et planification de l'intervention.",
                  },
                  {
                    n: '04',
                    t: 'Réalisation',
                    d: 'Déménagement effectué avec soin par nos équipes.',
                  },
                ].map((step, idx) => (
                  <div key={idx} className="relative pl-12 lg:pl-0 lg:text-center group">
                    ...
                    <h4 className="font-bold text-brand-900 dark:text-white mb-2">
                      {step.t}
                    </h4>
      ...
      <section className="py-24 bg-white dark:bg-slate-950">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <div className="mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white mb-6 italic tracking-tight uppercase">
              Notre{' '}
              <span className="text-accent underline decoration-accent/10 underline-offset-8">
                Équipe
              </span>
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-light leading-relaxed">
              Une équipe à dimension humaine pour un accompagnement de proximité
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12 max-w-7xl mx-auto">
            {[
              ...
              <div
                key={member.name}
                className={`group space-y-6 ${member.offset ? 'md:mt-12' : ''}`}
              >
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-4 tracking-tight">
              Des services adaptés aux particuliers et aux entreprises
            </h2>

            <p className="text-slate-500 dark:text-slate-400 font-light">
              Découvrez nos solutions pour répondre à toutes vos problématiques
              de mobilité.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {SERVICES.map((service) => (
              <Link
                key={service.id}
                to={service.path}
                className="group bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 hover:border-accent transition-all hover:shadow-xl flex flex-col h-full"
              >
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm font-light leading-relaxed mb-6 flex-grow">
                  {service.description}
                </p>
            ...
            <Link
              ...
              className="group bg-brand-900 p-8 rounded-[2rem] border border-brand-800 hover:border-accent transition-all hover:shadow-xl flex flex-col h-full text-white"
            >
              ...
              <p className="text-slate-300 text-sm font-light leading-relaxed mb-6 flex-grow">
                Découvrez nos 3 formules Économique, Standard et Luxe pour votre
                déménagement.
              </p>
      ...
      <section className="py-24 dark:bg-slate-950">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-12 text-center">
              Pourquoi choisir Marne Transdem ?
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              {[
                ...
                <div key={idx} className="flex items-start gap-4">
                  ...
                  <span className="text-lg text-brand-900 dark:text-white font-medium">
                    {point}
                  </span>
                </div>
              ))}
      ...
      <section className="py-24 bg-brand-900 dark:bg-slate-950 text-white relative overflow-hidden transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-300 dark:text-slate-400 font-light">
              Ce qui guide nos interventions au quotidien.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-white/5 dark:bg-slate-900 backdrop-blur-sm p-10 rounded-[2.5rem] border border-white/10 dark:border-slate-800 hover:bg-white/10 dark:hover:bg-slate-800/80 transition-colors"
              >
                ...
                <p className="text-slate-400 dark:text-slate-500 font-light text-sm leading-relaxed">
                  {value.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-brand-900 dark:text-white mb-6">
                Une entreprise de déménagement à Paris et en Île-de-France
              </h2>

              <p className="text-slate-500 dark:text-slate-400 font-light leading-relaxed text-lg mb-8">
                Basée au {CONTACT.fullAddress}, Marne Transdem intervient à
            ...
            <div className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              <h3 className="text-xs font-black text-brand-900 dark:text-white uppercase tracking-[0.4em] mb-8 text-center opacity-40">
                Zones desservies
              </h3>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="bg-slate-50 dark:bg-slate-800 py-3 px-4 rounded-xl text-center text-sm font-bold text-brand-900 dark:text-white border border-slate-100 dark:border-slate-700"
                  >
                    {zone}
                  </div>
                ))}
              ...
              <p className="mt-8 text-[10px] text-slate-400 dark:text-slate-500 text-center italic">
                * Selon étude et volume du projet.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 text-center dark:bg-slate-950">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl lg:text-5xl font-black text-brand-900 dark:text-white mb-8 tracking-tight">
          ...
          <p className="text-xl text-slate-500 dark:text-slate-400 mb-12 max-w-2xl mx-auto font-light leading-relaxed">
            Expliquez-nous votre projet afin d’obtenir une estimation adaptée à
            votre volume, vos accès et le niveau d’accompagnement souhaité.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              to="/demande-de-devis"
              className="bg-accent text-white px-12 py-5 rounded-full font-bold text-lg hover:bg-accent/90 transition-all shadow-xl shadow-accent/20"
            >
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <h2 className="text-3xl font-bold text-brand-900 dark:text-white mb-12 text-center">
            Questions fréquentes sur Marne Transdem
          </h2>
          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              <div
                key={i}
                className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex gap-6 items-start"
              >
                ...
                <div>
                  <h4 className="font-bold text-brand-900 dark:text-white text-lg mb-3">
                    {faq.q}
                  </h4>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl lg:text-6xl font-black text-white mb-8">
                  Contacter Marne Transdem
                </h2>

                <p className="text-xl text-slate-300 dark:text-slate-400 font-light mb-12 leading-relaxed">
                  Notre équipe est à votre écoute pour organiser votre prochain
                  déménagement à Paris ou en Île-de-France.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12">
                  <div className="space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-slate-500 dark:text-slate-600 font-black">
                      Notre bureau
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <Link
                    to="/demande-de-devis"
                    className="bg-accent text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-accent/90 transition-all text-center"
                  >
                    Demander mon devis
                  </Link>
                  ...
                  <a
                    href={`tel:${CONTACT.phone.replace(/\s/g, '')}`}
                    className="bg-white dark:bg-slate-800 text-brand-900 dark:text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-all flex items-center justify-center gap-3"
                  >
                    <Phone size={20} className="text-accent" />
                    Nous appeler
                  </a>
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    <div className="mb-10">
                      ...
                      <h3 className="text-3xl font-black text-white leading-tight">
                        Marne <br />
                        <span className="text-accent underline decoration-white/10 underline-offset-4">
                          Transdem
                        </span>
                      </h3>
                    </div>
                    ...
                    <div className="space-y-8 flex-grow">
                      <div className="group/item">
                        <div className="text-[10px] uppercase tracking-widest text-slate-500 dark:text-slate-600 font-black mb-3">
                          Notre bureau
                        </div>
                    ...
                    <div className="mt-auto pt-8">
                      <Link
                        to="/demande-de-devis"
                        className="block w-full bg-white dark:bg-accent text-brand-900 dark:text-brand-950 py-4 rounded-2xl font-black text-center hover:bg-accent dark:hover:bg-white hover:text-white dark:hover:text-brand-950 transition-all shadow-lg hover:shadow-accent/20"
                      >
                        Demander un devis
                      </Link>
                    </div>
