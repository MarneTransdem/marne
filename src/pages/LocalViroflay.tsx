...
const LocalViroflay: React.FC = () => {
  const path = "/demenagement-viroflay";
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-display">
      <SEO 
        title="Déménagement Viroflay | Marne Transdem" 
        description="Préparez votre déménagement à Viroflay avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé." 
        canonical={path}
        schema={[
          getBreadcrumbSchema([
            { name: "Accueil", item: "/" },
            { name: "Secteurs", item: "/secteurs-desservis" },
            { name: "Déménagement Viroflay", item: path }
          ]),
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-brand-900 overflow-hidden italic font-display">
        <div className="absolute inset-0 bg-[url('/images/demenagement-viroflay-78.jpg')] bg-cover bg-center opacity-20"></div>
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[1.1] tracking-tight text-white uppercase italic">
                Déménagement <span className="text-accent underline-offset-4">Viroflay</span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mb-10 leading-relaxed font-medium italic opacity-80 font-display">
                Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Viroflay, avec une organisation adaptée aux appartements, maisons, résidences et contraintes d'accès de l'ouest francilien.
              </p>
      ...
      <div className="bg-white border-b border-slate-100 py-4 font-display italic shadow-sm">
        <div className="container mx-auto px-4 md:px-6">
          <nav className="flex text-xs font-bold uppercase tracking-widest text-slate-400 italic font-display">
            ...
            <span className="mx-3 text-slate-200">/</span>
            <span className="text-brand-900 font-black italic">Viroflay</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic font-display">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-medium opacity-80 italic font-display">
                ...
                <p>
                  Marne Transdem accompagne les déménagements à Viroflay pour les particuliers et les entreprises. Qu'il s'agisse d'appartements en résidence, de studios, de maisons de ville ou de logements familiaux, nous maîtrisons les contraintes spécifiques d'accès d'immeubles : escaliers, ascenseurs, parkings et zones de stationnement.
                </p>
                <p>
              ...
              <div className="pt-4 flex flex-wrap gap-4 italic font-display">
                <div className="flex items-center gap-3 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100 shadow-sm transition-all hover:shadow-md">
                  ...
                  <span className="text-brand-900 font-bold uppercase tracking-wider text-xs italic">Viroflay (78220)</span>
                </div>
                <div className="flex items-center gap-3 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100 shadow-sm transition-all hover:shadow-md">
            ...
            <div className="relative font-display italic">
              <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 border-8 border-slate-50 shadow-brand-900/10">
                <img 
                  src="/images/demenagement-viroflay-78.jpg" 
                  alt="Déménagement Viroflay 78 - Service professionnel Marne Transdem" 
      ...
      {/* 3. Pourquoi un déménagement à Viroflay demande une bonne préparation */}
      <section className="py-24 bg-slate-50 font-display italic shadow-inner">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-display">
          <h2 className="text-4xl font-black text-brand-900 mb-6 tracking-tight uppercase px-4 italic">Préparer votre déménagement à Viroflay</h2>
          <p className="text-slate-600 text-lg max-w-3xl mx-auto font-medium opacity-80 px-4 italic font-display">
            Entre Versailles et les Hauts-de-Seine, la logistique à Viroflay nécessite une anticipation des accès et des configurations urbaines.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Gestion des immeubles avec étages, ascenseurs et parkings pour les appartements et studios.",
                icon: Home
              },
              {
                title: "Accès & Pentes",
                desc: "Anticipation des rues et accès spécifiques selon la topographie et la configuration de l'adresse.",
                icon: Truck
              },
              {
                title: "Protection & Fragiles",
                desc: "Emballage spécifique pour les meubles familiaux, la vaisselle, les livres et objets de valeur.",
                icon: Package
              },
              {
                title: "Transferts Professionnels",
                desc: "Organisation méthodique pour les bureaux, agences, commerces et professions libérales.",
                icon: Building2
              },
              {
              ...
              },
              {
                ...
                desc: "Solution de garde-meuble sécurisée en cas de travaux, vente immobilière ou achat différé.",
                icon: Warehouse
              }
            ].map((item, id) => (
      ...
      {/* 4. Nos services de déménagement à Viroflay */}
      <section className="py-24 bg-brand-900 text-white overflow-hidden relative shadow-2xl">
        ...
        <div className="container mx-auto px-4 md:px-6 mb-20 text-center relative z-10 px-4 text-white font-display italic">
          <h2 className="text-4xl md:text-5xl font-black mb-8 tracking-tight italic uppercase underline-offset-4">Nos services à Viroflay</h2>
      ...
      {/* 5. Déménagement de particuliers à Viroflay */}
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-display">
          <div className="flex flex-col lg:flex-row gap-20 items-center italic shadow-sm">
            <div className="lg:w-1/2 order-2 lg:order-1 relative italic font-display">
                <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 transition-transform duration-700 hover:scale-[1.02] shadow-brand-900/10 italic">
                  <img 
                    ...
                    alt="Déménagement particulier à Viroflay - Appartement et maison" 
            ...
            <div className="lg:w-1/2 order-1 lg:order-2 space-y-8 px-4 font-display italic shadow-sm">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight italic uppercase underline-offset-4 shadow-sm">Particuliers & Mobilité</h2>
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium italic opacity-80 font-display shadow-sm">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs déménagements à Viroflay : appartements en résidence, studios ou maisons de ville.
                </p>
                <p>
                  De Viroflay vers Paris, ou de Paris vers Viroflay, nous assurons une logistique sans faille. Tri, préparation des cartons, protection des meubles et prise en compte des accès (ascenseur, cave, garage, parking) : nos équipes adaptent leurs moyens à votre projet de vie dans les Yvelines ou vers l'Île-de-France.
                </p>
              </div>
      ...
      {/* 6. Déménagement d'entreprises à Viroflay */}
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-20 items-center italic font-display shadow-sm px-4 shadow-brand-900/5">
             <div className="lg:w-1/2 shadow-sm italic">
                <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative border-8 border-white p-2 shadow-brand-900/10 italic transition-transform hover:scale-[1.02]">
                  <img src="/images/transfert-bureaux-entreprise-paris.jpg" alt="Déménagement d'entreprise et transfert de bureaux à Viroflay 78" className="w-full h-full object-cover rounded-[2.5rem] shadow-sm font-display italic" />
                </div>
             </div>
             <div className="lg:w-1/2 space-y-8 px-4 font-display italic shadow-sm">
               <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight italic uppercase underline-offset-4 shadow-sm italic">Solutions Professionnelles</h2>
               <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium opacity-80 italic font-display shadow-sm underline-offset-2">
                 <p>
                   Nous intervenons auprès des bureaux, commerces et agences de Viroflay pour leurs transferts et locaux professionnels.
                 </p>
                 <p>
                    Mobilier, matériel informatique, archives : nous planifions chaque intervention pour minimiser l'impact sur votre continuité d'activité. Notre proximité avec Versailles, Chaville et Meudon nous permet d'être réactifs pour tous vos projets de transfert dans le sud-ouest de l'Île-de-France.
                 </p>
               </div>
               <div className="pt-8 shadow-sm">
                 <Link 
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 italic font-display shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 px-4 shadow-xl font-display italic shadow-brand-900/5">
            {[
              {
                name: "Économique",
                desc: "Préparation des cartons par vos soins, manutention et transport sécurisé par Marne Transdem.",
                icon: Calculator
              },
              {
                name: "Standard",
                desc: "Formule équilibrée incluant l'emballage de vos objets fragiles et la protection de vos meubles.",
                icon: Layout
              },
              {
                name: "Luxe",
                desc: "Prise en charge complète de la préparation et de l'emballage pour un déménagement clé en main.",
                icon: ShieldCheck
              }
            ].map((formula, idx) => (
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 italic shadow-sm italic font-display">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic font-display shadow-sm">
             <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white italic shadow-sm shadow-brand-900/10 transition-transform hover:scale-[1.01] shadow-brand-900/5">
               <img src="/images/camion-demenageur-marne-transdem.jpg" alt="Camion de déménagement Marne Transdem à Viroflay" className="w-full h-full object-cover font-display italic shadow-sm shadow-black/5" />
             </div>
             <div className="space-y-8 shadow-sm px-4 shadow-brand-900/10 italic font-display underline-offset-4 italic">
               <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight px-4 uppercase italic shadow-sm">Volume & Accès à Viroflay</h2>
               <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium opacity-80 px-4 italic font-display shadow-sm underline-offset-2">
                 <p>
                    Certains déménagements à Viroflay demandent une étude attentive du volume, des étages, des ascenseurs ou de la configuration de la rue. Nous évaluons les besoins en stationnement et les spécificités des accès (hall, escalier, cave, garage).
                 </p>
                 <p>
                    Pour les meubles volumineux ou les accès complexes par l'extérieur, nous pouvons étudier la faisabilité technique de la mise en place d'un monte-meuble selon votre adresse.
                 </p>
               </div>
           ...
           <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-20 items-center px-4 shadow-sm font-display italic font-display italic shadow-sm">
             <div className="lg:w-2/3 space-y-8 italic px-4 font-display italic shadow-smText text-white">
                ...
                <p className="text-slate-300 text-lg font-medium leading-relaxed opacity-80 px-4 italic underline-offset-4 shadow-sm font-display">
                  Avant de solliciter un devis personnalisé, utilisez notre calculateur de volume pour obtenir une estimation indicative de vos cartons, meubles et objets principaux.
                </p>
      ...
      <section className="py-24 bg-white font-display italic shadow-sm px-4 shadow-2xl underline-offset-4 shadow-black/5 italic font-display shadow-sm shadow-brand-900/5">
        <div className="container mx-auto px-4 md:px-6 text-center mb-20 px-4 shadow-sm italic font-display shadow-sm font-display italic shadow-sm">
          ...
          <p className="text-slate-500 text-xl font-medium max-w-2xl mx-auto italic opacity-70 shadow-sm px-4 shadow-sm italic font-display shadow-sm">Une organisation rigoureuse pour votre mobilité à Viroflay.</p>
        </div>
        <div className="container mx-auto px-4 md:px-6 italic font-display shadow-sm px-4 shadow-brand-900/5 italic font-display italic shadow-sm px-4">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative overflow-hidden px-4 shadow-sm font-display italic shadow-brand-900/10">
             ...
             {[
               ...
               { id: "02", title: "Audit technique", desc: "Évaluation des accès, parkings et spécificités logistiques de votre adresse à Viroflay." },
               { id: "03", title: "Choix formule", desc: "Organisation des équipes, préparation du matériel de protection et planification." },
      ...
      {/* 11. Secteurs proches de Viroflay */}
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 shadow-brand-900/20 font-display italic shadow-sm font-display italic shadow-sm underline-offset-4">
          <div className="max-w-4xl mx-auto space-y-12 px-4 shadow-sm shadow-brand-900/20 italic px-4 shadow-2xl font-display shadow-brand-900/10 italic shadow-sm font-display italic font-display shadow-sm shadow-brand-900/10">
            <div className="text-center mb-16 shadow-sm shadow-brand-900/10 italic font-display italic font-display italic shadow-sm uppercase underline-offset-8 italic">
               ...
               <h2 className="text-4xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight shadow-sm px-4 underline-offset-4 italic font-display font-display font-display italic uppercase shadow-sm">Vos questions sur Viroflay</h2>
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm shadow-brand-900/40 font-display italic font-display shadow-sm font-display italic font-display shadow-sm shadow-black/40 italic font-display italic shadow-sm">
           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 font-display italic shadow-brand-900/20 font-display italic shadow-sm font-display italic font-display italic shadow-sm">
             ...
             <div className="space-y-6 shadow-sm shadow-brand-900/20 font-display italic shadow-sm font-display shadow-sm italic font-display shadow-sm italic font-display shadow-sm italic font-display shadow-sm italic font-display shadow-sm">
                <h4 className="text-accent text-[10px] uppercase font-black tracking-widest italic tracking-[0.2em] opacity-80 shadow-sm shadow-accent/40 italic font-display shadow-sm italic shadow-sm underline italic">Outils</h4>
             ...
             <div className="space-y-6 shadow-sm shadow-brand-900/20 font-display italic shadow-sm font-display shadow-sm italic shadow-sm font-display italic shadow-sm font-display shadow-sm underline-offset-4 shadow-sm">
                <h4 className="text-accent text-[10px] uppercase font-black tracking-widest italic tracking-[0.2em] opacity-80 shadow-sm shadow-accent/40 italic font-display shadow-sm italic shadow-sm font-display italic underline">Yvelines & IDF</h4>
      ...
      <div className="sr-only font-display italic font-display shadow-sm font-display italic font-display shadow-sm font-display italic font-display shadow-sm font-display font-display italic font-display shadow-sm font-display italic font-display underline shadow-sm italic font-display italic">
        <p>
          Marne Transdem, expert du déménagement à Viroflay (78220) et d'Île-de-France, vous accompagne pour tous vos projets : transfert de bureaux Viroflay, déménagement d'entreprises, déménagement particulier, appartement, studio, maison, résidence, location monte-meuble et garde-meuble. Devis gratuit pour professionnels et particuliers. Proximité Versailles, Chaville, Vélizy-Villacoublay, Sèvres, Meudon, Jouy-en-Josas, Ville-d’Avray, Saint-Cloud et Paris ouest. Estimation volume, protection meubles, emballage cartons et transport sécurisé.
        </p>
      </div>
    </div>
  );
