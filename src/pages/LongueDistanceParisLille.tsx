...
const LongueDistanceParisLille: React.FC = () => {
  const path = "/demenagement-paris-lille";
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO 
        title="Déménagement Paris Lille | Marne Transdem"
        description="Organisez votre déménagement de Paris vers Lille avec Marne Transdem. Volume, emballage, transport longue distance, formules adaptées et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-[1.1] tracking-tight italic">
              Paris <span className="text-accent italic">Lille</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed font-light max-w-3xl italic font-sans">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement depuis Paris ou l’Île-de-France vers Lille, avec une organisation adaptée au volume, aux accès, à la distance et au niveau d’accompagnement souhaité.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/10 underline-offset-8">
                Préparer un déménagement <br/><span className="text-accent italic">de Paris vers Lille</span>
              </h2>
            ...
            <div className="relative rounded-[3rem] overflow-hidden shadow-2xl grayscale-[20%] transition-all h-full aspect-square">
               <img src="/images/demenagement-longue-distance-camion.jpg" alt="Paris Lille Transport" width="800" height="800" loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>

      {/* 3. Section “Pourquoi un déménagement Paris Lille demande une bonne organisation” */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
            <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 mb-6">Logistique <span className="text-accent italic tracking-tight italic italic">Liaison Nord</span></h2>
            <p className="text-slate-500 text-lg font-light italic max-w-3xl mx-auto italic font-sans italic">
              Malgré la proximité relative, un trajet vers le Nord demande une coordination parfaite du chargement et une anticipation des accès urbains.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 italic font-sans">
            {[
              { icon: Truck, t: "Trajet A1 / Nord", d: "Gestion sécurisée du transport sur l'axe autoroutier reliant la capitale à la métropole lilloise." },
              ...
              { icon: Calendar, t: "Suivi Planning", d: "Coordination des dates pour assurer la fluidité de votre transition vers votre nouveau logement lillois." }
            ].map((item, i) => (
      ...
      {/* 4. Nos services pour votre déménagement Paris Lille */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
           <h2 className="text-3xl md:text-5xl font-black text-brand-900 uppercase italic tracking-tight underline italic">Services <span className="text-accent italic tracking-tight italic underline italic underline-offset-4 italic">longue distance</span></h2>
        </div>
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 italic">
          {[
            { t: "Particuliers", d: "Accompagnement des familles qui quittent Paris ou l’Île-de-France pour s’installer à Lille.", l: "/demenagement-particuliers-paris" },
            { t: "Entreprises", d: "Organisation des transferts professionnels entre Paris, l’Île-de-France et Lille.", l: "/demenagement-entreprises-paris" },
      ...
      {/* 5. Déménagement Paris Lille pour les particuliers */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center italic">
            <div className="lg:w-1/2 rounded-[3.5rem] overflow-hidden shadow-2xl relative order-2 lg:order-1 grayscale-[10%]">
               <img src="/images/demenagement-maison-appartement-particulier.jpg" alt="Particulier Paris Lille" width="800" height="600" loading="lazy" decoding="async" className="w-full h-full object-cover italic transition-all h-full grayscale-[10%]" />
            </div>
            <div className="lg:w-1/2 space-y-8 order-1 lg:order-2 italic font-sans italic">
              <h2 className="text-3xl md:text-4xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 italic transition-all">Particuliers de Paris vers Lille</h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic italic">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs projets de mutation, rapprochement familial ou <span className="font-bold text-slate-700 tracking-tight italic tracking-tight">installation à Lille</span>.
                </p>
                <p>
                   Appartement, maison ou studio, nous gérons votre transport au <span className="font-bold text-slate-700 tracking-tight italic">départ vers le nord</span> avec une expertise sur la protection de vos meubles et objets fragiles. Nous intégrons vos besoins de stationnement et d'accès pour garantir une livraison sereine quel que soit votre quartier d'arrivée.
                </p>
              </div>
              <Link to="/demande-de-devis" className="inline-flex items-center gap-3 bg-brand-900 text-white px-10 py-5 rounded-full font-bold hover:bg-accent hover:text-brand-900 transition-all shadow-xl italic tracking-tight italic h-full transition-all italic">
                Demander mon devis Paris Lille <ArrowRight size={18} />
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* 6. Déménagement Paris Lille pour les entreprises */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-20 items-center italic">
             <div className="lg:w-1/2 rounded-[3.5rem] overflow-hidden shadow-2xl relative grayscale-[10%] italic transition-all h-full transition-all italic grayscale-[10%]">
                <img src="/images/transfert-bureaux-entreprise-paris.jpg" alt="Entreprise Paris Lille" width="800" height="600" loading="lazy" decoding="async" className="w-full h-full object-cover italic transition-all h-full" />
             </div>
             <div className="lg:w-1/2 space-y-8 italic font-sans italic italic">
               <h2 className="text-3xl md:text-4xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 italic transition-all italic h-full underline decoration-accent/20 underline-offset-4 italic">Transfert professionnel Paris Lille</h2>
               <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic italic italic">
                 <p>
                   Marne Transdem accompagne les entreprises, bureaux et agences dans leur <span className="font-bold text-brand-900 italic tracking-tight">transfert professionnel</span> de Paris ou l'Île-de-France vers Lille.
                 </p>
                 <p>
                    Nous assurons le transport rigoureux de votre mobilier de bureau, <span className="font-bold text-slate-700 tracking-tight italic text-slate-700 font-bold italic">archives</span> et matériel informatique. Notre planning est coordonné pour favoriser la continuité de vos activités lors de votre délocalisation vers la métropole lilloise.
                 </p>
               </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic font-sans italic underline underline-offset-8 italic underline transition-all">
            <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 transition-all font-sans italic">Votre départ <span className="text-accent italic tracking-tight italic italic underline italic underline-offset-4 italic">d'IDF ou de Paris</span></h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic transition-all italic grayscale-[0%] transition-all">
             <div className="space-y-8 italic transition-all transition-all italic transition-all">
               ...
               <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed italic italic italic italic transition-all italic italic transition-all italic transition-all italic transition-all italic">
                 <p>
                   L’arrivée à <span className="text-white font-bold italic tracking-tight transition-all">Lille</span> doit aussi être anticipée selon les spécificités de votre adresse de destination. Qu'il s'agisse d'un appartement de caractère dans le Vieux-Lille ou d'un projet moderne dans la métropole, la configuration des accès conditionne notre organisation.
                 </p>
             ...
             <div className="bg-white/5 rounded-[3.5rem] p-12 lg:p-20 border border-white/10 backdrop-blur-md shadow-2xl space-y-8 italic font-sans italic transition-all italic transition-all transition-all italic transition-all italic font-sans italic transition-all h-full text-brand-900 bg-white">
                ...
                <p className="text-slate-500 italic font-light italic leading-relaxed text-sm italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
                  Marne Transdem étudie la faisabilité technique à l'arrivée. Le besoin d'un monte-meuble sera confirmé selon les accès extérieurs et la configuration de la rue à Lille.
                </p>
             </div>
          </div>
        </div>
      ...
      {/* 9. Formules adaptées à un déménagement Paris Lille */}
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline underline-offset-8 decoration-accent/20 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
          <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 italic transition-all italic font-sans italic transition-all italic transition-all">Formules Paris Lille</h2>
        </div>
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
          {[
            { n: "Économique", d: "Manutention et transport sécurisé vers le nord. Vous assurez la préparation intégrale de vos cartons." },
            { n: "Standard", d: "Formule équilibrée avec délégation des objets fragiles et protection complète du mobilier." },
            { n: "Luxe", d: "Délégation maximale incluant préparation, emballage et organisation experte de votre trajet." }
          ].map((f, i) => (
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all italic font-sans italic transition-all italic transition-all italic">
           <div className="max-w-4xl mx-auto space-y-12 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all">
             ...
             <p className="text-slate-500 text-lg font-light leading-relaxed italic italic italic italic italic transition-all italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
                L'organisation du transport entre Paris et Lille dépend de l'étude précise du <span className="font-bold text-brand-900 italic tracking-tight">volume</span>, des accès et du niveau d'emballage souhaité.
             </p>
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 italic font-sans">
                <Link to="/calculateur-volume" className="bg-slate-900 p-8 rounded-3xl group flex flex-col justify-between h-full italic transition-all hover:bg-black transition-all italic transition-all h-full italic transition-all transition-all italic transition-all italic transition-all italic transition-all">
                   ...
                   <h4 className="text-white font-bold italic transition-all italic transition-all italic transition-all italic transition-all font-sans uppercase text-sm tracking-widest italic group-hover:text-accent transition-all italic transition-all italic transition-all">Calculateur Volume</h4>
                </Link>
                <Link to="/location-monte-meuble-paris" className="bg-slate-50 p-8 rounded-3xl group border border-slate-100 flex flex-col justify-between h-full italic transition-all hover:border-accent transition-all italic transition-all h-full italic transition-all transition-all italic transition-all italic transition-all italic transition-all">
                   ...
                   <h4 className="text-brand-900 font-bold italic transition-all italic transition-all italic transition-all italic transition-all font-sans uppercase text-sm tracking-widest italic transition-all italic transition-all italic transition-all">Location Monte-meuble</h4>
                </Link>
             </div>
           </div>
        </div>
      ...
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          ...
          <p className="text-slate-500 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all transition-all">
            Utilisez notre calculateur pour estimer vos meubles et cartons. Cette première approche indicative sera affinée lors de l'étude de votre devis pour votre trajet de Paris vers Lille.
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 text-center italic font-sans transition-all italic transition-all transition-all italic h-full transition-all">
            {[
              ...
              { icon: Box, t: "Préparation", d: "Formule, cartons et protection." },
              { icon: Truck, t: "Transport", d: "Transport sécurisé vers Lille." },
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
             <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 transition-all font-sans italic">Province <span className="text-accent italic tracking-tight italic italic underline italic underline-offset-4 italic">depuis Paris</span></h2>
          </div>
      ...
      <section className="py-24 bg-brand-900 relative overflow-hidden font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10 italic transition-all">
           ...
           <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
             Décrivez votre projet vers le Nord et recevez une estimation adaptée à votre volume et vos accès au départ de l'Île-de-France.
           </p>
      ...
      <section className="py-24 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
           <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-4 font-display uppercase italic tracking-tight transition-all font-sans italic underline decoration-accent/20 underline-offset-[12px] italic transition-all underline italic transition-all underline-offset-2">FAQ PARIS LILLE</h2>
           </div>
      ...
      <section className="py-12 bg-slate-900 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
          <div className="flex flex-wrap justify-center gap-x-10 gap-y-6 text-[10px] font-black uppercase tracking-[0.25em] text-slate-500 italic pb-8 border-b border-white/5 italic italic italic transition-colors transition-all italic transition-all italic transition-all italic transition-all italic transition-all underline decoration-accent/10 transition-all font-sans italic transition-all italic transition-all italic">
            ...
            <Link to="/calculateur-volume" className="hover:text-accent transition-all italic italic transition-all italic transition-all italic selection:bg-accent italic transition-all italic transition-all uppercase">Calculateur Volume</Link>
            <Link to="/formules-demenagement" className="hover:text-accent transition-all italic italic transition-all italic transition-all italic selection:bg-accent italic transition-all italic transition-all uppercase">Nos Formules</Link>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-4 text-[8px] font-black uppercase tracking-[0.15em] text-slate-700 italic pt-8 font-sans italic italic transition-colors transition-all italic transition-all italic transition-all italic transition-all italic transition-all underline decoration-accent/10 transition-all font-sans italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic selection:bg-accent italic">
            ...
            <Link to="/demenagement-paris-lyon" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Lyon</Link>
            <Link to="/demenagement-paris-marseille" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Marseille</Link>
            <Link to="/demenagement-paris-bordeaux" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Bordeaux</Link>
            <Link to="/demenagement-paris-toulouse" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Toulouse</Link>
            <Link to="/demenagement-paris-nantes" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Nantes</Link>
            <Link to="/demenagement-paris-strasbourg" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Strasbourg</Link>
            <Link to="/demenagement-paris-montpellier" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Montpellier</Link>
            <Link to="/demenagement-paris-rennes" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Paris-Rennes</Link>
          </div>
        </div>
      </section>
    </div>
...
export default LongueDistanceParisLille;
