...
const LocalValDOise: React.FC = () => {
  ...
  const cities = [
    ...
    { n: "Montmorency", d: "Déménagements premium pour pavillons de standing avec accès techniques complexes.", l: "/demenagement-montmorency" },
    { n: "Saint-Gratien", d: "Solutions pour particuliers et entreprises proches du pôle Enghien-Soisy.", l: "/demenagement-saint-gratien" },
