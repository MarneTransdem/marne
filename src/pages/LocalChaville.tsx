...
const LocalChaville: React.FC = () => {
  const path = "/demenagement-chaville";
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-display">
      <SEO 
        title="Déménagement Chaville | Marne Transdem" 
        description="Préparez votre déménagement à Chaville avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé." 
        canonical={path}
        schema={[
          getBreadcrumbSchema([
            { name: "Accueil", item: "/" },
            { name: "Secteurs", item: "/secteurs-desservis" },
            { name: "Déménagement Chaville", item: path }
          ]),
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-brand-900 overflow-hidden italic font-display">
        <div className="absolute inset-0 bg-[url('/images/demenagement-chaville-hauts-de-seine.jpg')] bg-cover bg-center opacity-20"></div>
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[1.1] tracking-tight text-white uppercase italic">
                Déménagement <span className="text-accent underline-offset-4">Chaville</span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mb-10 leading-relaxed font-medium italic opacity-80 font-display">
                Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Chaville, avec une organisation adaptée aux appartements, maisons et locaux professionnels de l'ouest parisien.
              </p>
      ...
      <div className="bg-white border-b border-slate-100 py-4 font-display italic shadow-sm">
        <div className="container mx-auto px-4 md:px-6">
          <nav className="flex text-xs font-bold uppercase tracking-widest text-slate-400 italic font-display">
            ...
            <span className="mx-3 text-slate-200">/</span>
            <span className="text-brand-900 font-black italic">Chaville</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic font-display">
            ...
            >
              ...
              <div className="pt-4 flex flex-wrap gap-4 italic font-display">
                <div className="flex items-center gap-3 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100 shadow-sm transition-all hover:shadow-md">
                  ...
                  <span className="text-brand-900 font-bold uppercase tracking-wider text-xs italic">Chaville (92370)</span>
                </div>
                <div className="flex items-center gap-3 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100 shadow-sm transition-all hover:shadow-md">
                  <Trees className="text-brand-900 shadow-sm" size={24} />
                  <span className="text-brand-900 font-bold uppercase tracking-wider text-xs italic">Forêt & Ville</span>
                </div>
              </div>
            </motion.div>
            <div className="relative font-display italic">
              <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 border-8 border-slate-50 shadow-brand-900/10">
                <img 
                  src="/images/demenagement-chaville-hauts-de-seine.jpg" 
                  alt="Déménagement Chaville 92 - Service professionnel Marne Transdem" 
      ...
      {/* 3. Pourquoi un déménagement à Chaville demande une bonne préparation */}
      <section className="py-24 bg-slate-50 font-display italic shadow-inner">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-display">
          <h2 className="text-4xl font-black text-brand-900 mb-6 tracking-tight uppercase px-4 italic">Préparer votre logistique à Chaville</h2>
          <p className="text-slate-600 text-lg max-w-3xl mx-auto font-medium opacity-80 px-4 italic font-display">
            Ville résidentielle située entre les Hauts-de-Seine et les Yvelines, Chaville impose une préparation rigoureuse des accès.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Gestion des immeubles avec étages, halls traversants et parkings à préserver lors de la manutention.",
                icon: Home
              },
              {
                title: "Topographie Locale",
                desc: "Anticipation des rues en pente et des accès spécifiques de maisons ou jardins chavilois.",
                icon: Truck
              },
              {
                title: "Protection & Fragiles",
                desc: "Emballage soigné pour le mobilier familial, la vaisselle, les livres et les objets de valeur.",
                icon: Package
              },
              {
                title: "Bureaux & Cabinets",
                desc: "Transferts professionnels organisés pour limiter les interruptions d'activité des entreprises locales.",
                icon: Building2
              },
              {
                title: "Monte-meuble",
                desc: "Étude technique pour le levage extérieur lorsque les accès intérieurs sont trop limités.",
                icon: ArrowUpCircle
              },
              {
                title: "Transition & Stockage",
                desc: "Solutions de garde-meuble flexibles pour accompagner vos ventes ou achats immobiliers.",
                icon: Warehouse
              }
            ].map((item, id) => (
      ...
      {/* 4. Nos services de déménagement à Chaville */}
      <section className="py-24 bg-brand-900 text-white overflow-hidden relative shadow-2xl">
        ...
        <div className="container mx-auto px-4 md:px-6 mb-20 text-center relative z-10 px-4 text-white font-display italic">
          <h2 className="text-4xl md:text-5xl font-black mb-8 tracking-tight italic uppercase underline-offset-4">Nos services à Chaville</h2>
          <p className="text-slate-400 text-xl max-w-3xl mx-auto italic font-medium opacity-80 text-slate-300 shadow-sm underline-offset-2">Une expertise complète pour les particuliers et professionnels de l'ouest parisien.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 italic font-display">
            {[
              ...
              },
              {
                ...
                desc: "Bureaux, commerces, cabinets et agences de Chaville.",
              ...
              },
              {
                ...
                desc: "Solution technique selon les accès et la configuration de la rue.",
              ...
              },
              {
                ...
                desc: "Estimation indicative pour affiner votre planification logistique.",
      ...
      {/* 5. Déménagement de particuliers à Chaville */}
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-display">
          <div className="flex flex-col lg:flex-row gap-20 items-center italic shadow-sm">
            <div className="lg:w-1/2 order-2 lg:order-1 relative italic font-display">
                <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 transition-transform duration-700 hover:scale-[1.02] shadow-brand-900/10 italic">
                  <img 
                    ...
                    alt="Déménagement appartement et maison à Chaville - Solution pour particuliers" 
            ...
            <div className="lg:w-1/2 order-1 lg:order-2 space-y-8 px-4 font-display italic shadow-sm">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight italic uppercase underline-offset-4 shadow-sm">Particuliers & Résidences</h2>
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium italic opacity-80 font-display shadow-sm">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs déménagements à Chaville : appartements familiaux, résidences forestières ou maisons de ville.
                </p>
                <p>
                  De Chaville vers Paris, ou de Paris vers Chaville, nous assurons chaque étape : tri, emballage des cartons, protection du mobilier et gestion des accès (ascenseur, cave, garage, parking). Nos équipes s'adaptent à votre projet pour une mobilité sereine vers l'Île-de-France ou la province.
                </p>
              </div>
      ...
      {/* 6. Déménagement d'entreprises à Chaville */}
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-20 items-center italic font-display shadow-sm px-4 shadow-brand-900/5">
             <div className="lg:w-1/2 shadow-sm italic">
                <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative border-8 border-white p-2 shadow-brand-900/10 italic transition-transform hover:scale-[1.02]">
                  <img src="/images/transfert-bureaux-entreprise-paris.jpg" alt="Déménagement entreprise et transfert de bureaux à Chaville" className="w-full h-full object-cover rounded-[2.5rem] shadow-sm font-display italic" />
                </div>
             </div>
             <div className="lg:w-1/2 space-y-8 px-4 font-display italic shadow-sm">
               <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight italic uppercase underline-offset-4 shadow-sm italic">Transferts de Bureaux & Cabinets</h2>
               <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium opacity-80 italic font-display shadow-sm underline-offset-2">
                 <p>
                   Nous intervenons auprès des professionnels de Chaville (bureaux, commerces, cabinets et agences) pour leurs transferts et locaux tertiaires.
                 </p>
                 <p>
                    Mobilier professionnel, matériel informatique et archives : nous planifions chaque phase pour garantir le respect de vos délais. Notre proximité avec Vélizy, Versailles et Sèvres nous permet d'être réactifs pour tous vos transferts dans le bassin économique de l'ouest parisien.
                 </p>
               </div>
               <div className="pt-8 shadow-sm">
                 <Link 
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 italic font-display shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 px-4 shadow-xl font-display italic shadow-brand-900/5">
            {[
              {
                name: "Économique",
                desc: "Marne Transdem gère la manutention et le transport sécurisé, vous préparez vos cartons.",
                icon: Calculator
              },
              {
                name: "Standard",
                desc: "Une solution équilibrée incluant l'emballage de vos objets fragiles et la protection de vos meubles.",
                icon: Layout
              },
              {
                name: "Luxe",
                desc: "Prise en charge complète pour un déménagement clé en main avec emballage intégral.",
                icon: ShieldCheck
              }
            ].map((formula, idx) => (
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 italic shadow-sm italic font-display">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic font-display shadow-sm">
             <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white italic shadow-sm shadow-brand-900/10 transition-transform hover:scale-[1.01] shadow-brand-900/5">
               <img src="/images/camion-demenageur-marne-transdem.jpg" alt="Logistique et camion de déménagement Marne Transdem à Chaville" className="w-full h-full object-cover font-display italic shadow-sm shadow-black/5" />
             </div>
             <div className="space-y-8 shadow-sm px-4 shadow-brand-900/10 italic font-display underline-offset-4 italic">
               <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight px-4 uppercase italic shadow-sm">Étude des accès à Chaville</h2>
               <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium opacity-80 px-4 italic font-display shadow-sm underline-offset-2">
                 <p>
                    Certains déménagements à Chaville demandent une étude attentive du volume, des étages, des halls d'immeubles ou des rues en pente. Nous anticipons les besoins en stationnement et les spécificités logistiques de chaque résidence ou pavillon.
                 </p>
                 <p>
                    Pour les meubles volumineux ou les accès complexes par les intérieurs, nous pouvons analyser la faisabilité technique d'un monte-meuble extérieur selon la configuration de votre adresse chavilloise.
                 </p>
               </div>
      ...
      <section className="py-24 bg-white font-display italic shadow-sm px-4 shadow-2xl underline-offset-4 shadow-black/5 italic font-display shadow-sm shadow-brand-900/5">
        <div className="container mx-auto px-4 md:px-6 text-center mb-20 px-4 shadow-sm italic font-display shadow-sm font-display italic shadow-sm">
          ...
          <p className="text-slate-500 text-xl font-medium max-w-2xl mx-auto italic opacity-70 shadow-sm px-4 shadow-sm italic font-display shadow-sm">Une organisation rigoureuse pour votre déménagement à Chaville.</p>
        </div>
        <div className="container mx-auto px-4 md:px-6 italic font-display shadow-sm px-4 shadow-brand-900/5 italic font-display italic shadow-sm px-4">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative overflow-hidden px-4 shadow-sm font-display italic shadow-brand-900/10">
             ...
             {[
               { id: "01", title: "Analyse projet", desc: "Étude globale de votre volume, de vos adresses Chaville/Paris et de votre calendrier." },
               { id: "02", title: "Audit technique", desc: "Évaluation des accès, étages et spécificités stationnement de votre adresse cible." },
               { id: "03", title: "Planification", desc: "Organisation des équipes, préparation du matériel de protection et logistique." },
      ...
      {/* 11. Secteurs proches de Chaville */}
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 shadow-brand-900/10 italic shadow-sm font-display italic">
          <div className="flex flex-col lg:flex-row gap-20 items-end mb-16 px-4 shadow-sm shadow-brand-900/10 italic font-display">
            <div className="lg:w-2/3 space-y-6 shadow-sm px-4 font-display italic">
              <span className="text-accent uppercase font-black tracking-widest text-[10px] mb-4 block tracking-[0.2em] opacity-80 shadow-sm italic shadow-accent/20">Sud-Ouest Francilien</span>
        ...
        <div className="container mx-auto px-4 md:px-6 shadow-sm px-4 shadow-brand-900/20 font-display italic shadow-sm font-display italic shadow-sm underline-offset-4">
          <div className="max-w-4xl mx-auto space-y-12 px-4 shadow-sm shadow-brand-900/20 italic px-4 shadow-2xl font-display shadow-brand-900/10 italic shadow-sm font-display italic font-display shadow-sm shadow-brand-900/10">
            <div className="text-center mb-16 shadow-sm shadow-brand-900/10 italic font-display italic font-display italic shadow-sm uppercase underline-offset-8 italic">
               ...
               <h2 className="text-4xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight shadow-sm px-4 underline-offset-4 italic font-display font-display font-display italic uppercase shadow-sm">Vos questions sur Chaville</h2>
               <p className="text-slate-500 font-medium italic opacity-80 shadow-sm italic font-display underline-offset-4 italic font-display italic underline shadow-sm italic underline-offset-8">Informations utiles pour votre déménagement dans le 92.</p>
            </div>
      ...
      <div className="sr-only font-display italic font-display shadow-sm font-display italic font-display shadow-sm font-display italic font-display shadow-sm font-display font-display italic font-display shadow-sm font-display italic font-display underline shadow-sm italic font-display italic">
        <p>
          Marne Transdem, expert du déménagement à Chaville (92370) et Hauts-de-Seine, vous accompagne pour tous vos projets : transfert de bureaux Chaville, déménagement d'entreprises, déménagement particulier, appartement, studio, maison, résidence, location monte-meuble et garde-meuble. Devis gratuit pour professionnels et particuliers. Proximité Sèvres, Meudon, Viroflay, Ville-d’Avray, Saint-Cloud, Vélizy-Villacoublay, Versailles et Paris ouest. Estimation volume, protection meubles, emballage cartons et transport sécurisé.
        </p>
      </div>
    </div>
  );
