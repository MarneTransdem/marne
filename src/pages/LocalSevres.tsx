...
const LocalSevres: React.FC = () => {
  const path = "/demenagement-sevres";
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <SEO 
        title="Déménagement Sèvres | Marne Transdem" 
        description="Préparez votre déménagement à Sèvres avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé." 
        canonical={path}
        schema={[
          getBreadcrumbSchema([
            { name: "Accueil", item: "/" },
            { name: "Secteurs", item: "/secteurs-desservis" },
            { name: "Déménagement Sèvres", item: path }
          ]),
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[1.1] tracking-tight text-white">
                Déménagement <span className="text-accent">Sèvres</span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mb-10 leading-relaxed font-medium">
                Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Sèvres, avec une organisation adaptée aux appartements, maisons, résidences et commerces du sud-ouest parisien.
              </p>
      ...
      <div className="bg-white border-b border-slate-100 py-4">
        <div className="container mx-auto px-4 md:px-6 text-white">
          <nav className="flex text-xs font-bold uppercase tracking-widest text-slate-400">
            ...
            <span className="mx-3 text-slate-200">/</span>
            <span className="text-brand-900">Déménagement Sèvres</span>
          </nav>
        </div>
      </div>
            ...
            >
              ...
              <div className="pt-4 flex flex-wrap gap-4">
                <div className="flex items-center gap-3 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <span className="text-brand-900 font-bold uppercase tracking-wider text-xs">Sèvres (92310)</span>
                </div>
                <div className="flex items-center gap-3 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100 shadow-sm">
                  <ShieldCheck className="text-brand-900" size={24} />
                  <span className="text-brand-900 font-bold uppercase tracking-wider text-xs">Expertise locale</span>
                </div>
              </div>
            </motion.div>
      ...
      {/* 3. Pourquoi un déménagement à Sèvres demande une bonne préparation */}
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 px-4">
          <h2 className="text-4xl font-black text-brand-900 mb-6 tracking-tight">Pourquoi un déménagement à Sèvres demande une bonne préparation</h2>
          <p className="text-slate-600 text-lg max-w-3xl mx-auto font-medium">
            Certaines spécificités de Sèvres imposent une organisation rigoureuse pour garantir la fluidité de votre projet de mobilité.
          </p>
        </div>
        <div className="container mx-auto px-4 md:px-6 font-display">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Topographie & Pentes",
                desc: "Sèvres présente des quartiers vallonnés avec des rues parfois en pente, nécessitant une attention particulière pour le stationnement du camion.",
                icon: MapPin
              },
              {
                title: "Logements avec Étages",
                desc: "Que ce soit en appartement avec ascenseur limité ou en maison, la gestion des étages est un facteur clé de l'organisation.",
                icon: ArrowUpCircle
              },
              {
                title: "Résidences & Parties Communes",
                desc: "La protection des halls d'entrée, des parkings et des accès d'immeubles est assurée pour respecter les règlements de copropriété.",
                icon: Building2
              },
              {
                title: "Accès Spécifiques",
                desc: "Caves, garages, cours ou jardins : chaque espace de stockage ou de passage est évalué lors de l'estimation technique.",
                icon: Warehouse
              },
              {
                title: "Monte-Meuble",
                desc: "Selon la configuration des lieux et la faisabilité technique, le recours à un monte-meuble peut être une solution pertinente.",
                icon: ArrowUpCircle
              },
              {
                title: "Bureaux & Commerces",
                desc: "Le transfert d'activité pour les professionnels sevriens demande une planification stricte pour minimiser l'impact sur l'activité.",
                icon: Building2
              }
            ].map((item, id) => (
      ...
      {/* 4. Nos services de déménagement à Sèvres */}
      <section className="py-24 bg-brand-900 text-white overflow-hidden relative">
        <div className="absolute bottom-0 left-0 w-1/4 h-full bg-accent opacity-5 skew-x-6 -translate-x-1/2"></div>
        <div className="container mx-auto px-4 md:px-6 mb-20 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-black mb-8 tracking-tight">Nos services de déménagement à Sèvres</h2>
          <p className="text-slate-400 text-xl max-w-3xl mx-auto italic font-medium font-display">Une expertise complète au service de votre sérénité.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Préparation du déménagement avec du matériel adapté.",
              ...
              },
              {
                ...
                desc: "Estimation indicative du volume avant établissement du devis.",
      ...
      {/* 5. Déménagement de particuliers à Sèvres */}
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2 order-2 lg:order-1 relative">
                <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 transition-transform duration-700 group-hover:scale-[1.02]">
                  <img 
                    src="/images/demenagement-appartement-92.jpg" 
                    alt="Déménagement particuliers Sèvres" 
                    className="w-full h-full object-cover"
                  />
                </div>
            ...
            <div className="lg:w-1/2 order-1 lg:order-2 space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight">Déménagement de particuliers à Sèvres</h2>
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium italic">
                <p>
                  Marne Transdem accompagne les familles, actifs et cadres résidant à Sèvres pour tous leurs besoins de déménagement d'appartements, de maisons ou de studios.
                </p>
                <p>
                  De Sèvres vers Paris, ou de Paris vers Sèvres, notre équipe assure la protection de vos biens, de vos objets fragiles et de vos effets personnels. Nous organisons chaque étape : tri, emballage, manutention par escalier ou ascenseur, et stockage temporaire en garde-meuble si nécessaire.
                </p>
              </div>
              <div className="pt-8">
                <Link 
      ...
      {/* 6. Déménagement d'entreprises à Sèvres */}
             ...
             <div className="lg:w-1/2">
                <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative border-8 border-white p-2">
                  <img 
                    ...
                    alt="Déménagement entreprises Sèvres" 
                    className="w-full h-full object-cover rounded-[2.5rem]"
                  />
                </div>
             </div>
             <div className="lg:w-1/2 space-y-8">
               <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight">Déménagement d'entreprises à Sèvres</h2>
               <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium">
                 <p>
                   Pour les professionnels de Sèvres, nous organisons les transferts de bureaux, d'agences et de cabinets libéraux. Notre proximité avec Saint-Cloud, Meudon, Boulogne-Billancourt et Paris 16e nous permet une logistique fluide et rapide.
                 </p>
                 <p>
                   Mobilier professionnel, archives, matériel informatique : notre équipe gère le planning pour minimiser l'arrêt de votre activité. Nous adaptons nos moyens de manutention aux configurations de vos locaux, y compris avec le recours à un stockage temporaire sécurisé si besoin.
                 </p>
               </div>
               <div className="pt-8">
                 <Link 
                   to="/demenagement-entreprises-paris" 
                   className="inline-flex bg-white border-2 border-brand-900 text-brand-900 px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-brand-900 hover:text-white transition-all active:scale-95 group font-display"
                 >
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-4 md:px-6 mb-16 text-center">
          <span className="text-accent uppercase font-black tracking-[0.2em] text-sm mb-4 block">Nos Offres</span>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {[
              {
                name: "Économique",
                desc: "Vous préparez vos cartons, Marne Transdem assure la manutention et le transport en toute sécurité.",
                icon: Calculator
              },
              {
                name: "Standard",
                desc: "Un équilibre parfait : nous gérons les objets fragiles et le mobilier, vous gérez le reste.",
                icon: Layout
              },
              {
                name: "Luxe",
                desc: "La sérénité totale : nous prenons en charge la majeure partie de la préparation et de l'emballage.",
                icon: ShieldCheck
              }
            ].map((formula, idx) => (
          ...
          <div className="mt-16 text-center">
             <Link 
              to="/formules-demenagement" 
              className="inline-flex items-center gap-4 bg-brand-900 text-white px-12 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-brand-800 transition-all active:scale-95 shadow-2xl"
             >
        ...
        <div className="container mx-auto px-4 md:px-6">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
             <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white">
               <img src="/images/camion-demenagement-val-de-marne.jpg" alt="Logistique à Sèvres" className="w-full h-full object-cover" />
             </div>
             <div className="space-y-8">
               <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight">Volume, accès et monte-meuble à Sèvres</h2>
               <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium italic">
                 <p>
                    L'organisation d'un déménagement à Sèvres peut nécessiter une étude technique approfondie des accès. Entre les résidences avec ascenseurs parfois exigus et les maisons disposant de caves, garages ou cours, chaque détail compte.
                 </p>
                 <p>
                    Le volume à déménager, l'étage et les contraintes de stationnement (rues étroites ou en pente) sont des paramètres essentiels. Lorsque le mobilier volumineux ne passe pas par l'escalier, nous pouvons proposer la location d'un monte-meuble sous réserve de faisabilité technique.
                 </p>
               </div>
               <div className="pt-6">
                 <Link 
                  ...
                  >
                    Voir les solutions monte-meuble <ArrowRight size={18} />
                 </Link>
               </div>
             </div>
           </div>
           ...
           <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-20 items-center px-4">
             <div className="lg:w-2/3 space-y-8">
                ...
                <p className="text-slate-400 text-lg font-medium leading-relaxed italic">
                  Avant de solliciter un devis, utilisez notre calculateur de volume en ligne pour obtenir une première estimation indicative de vos meubles et cartons. Cette donnée nous aidera à affiner votre proposition personnalisée pour Sèvres.
                </p>
                <div className="pt-4">
                  <Link 
             ...
             <div className="lg:w-1/3">
                <div className="aspect-square bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] p-12 flex items-center justify-center group relative">
                    <div className="absolute inset-0 bg-accent opacity-0 group-hover:opacity-10 transition-opacity blur-3xl"></div>
                    <Calculator size={140} className="text-accent group-hover:scale-110 transition-transform duration-700" />
                </div>
             </div>
           </div>
        </div>
      ...
      <section className="py-24 bg-white font-display">
        <div className="container mx-auto px-4 md:px-6 text-center mb-20 px-4">
          <h2 className="text-4xl md:text-5xl font-black text-brand-900 mb-6 tracking-tight leading-tight">Une méthode claire et efficace</h2>
          <p className="text-slate-500 text-xl font-medium max-w-2xl mx-auto italic">Nous vous accompagnons pas à pas pour votre déménagement à Sèvres.</p>
        </div>
        <div className="container mx-auto px-4 md:px-6">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative overflow-hidden px-4">
             <div className="hidden lg:block absolute top-12 left-[12%] right-[12%] h-[2px] bg-slate-100 -z-10"></div>
             {[
               { id: "01", title: "Analyse du projet", desc: "Étude de votre besoin, de la destination et du timing souhaité." },
               { id: "02", title: "Évaluation technique", desc: "Définition du volume et analyse des accès spécifiques à Sèvres." },
               ...
               <div key={idx} className="relative group text-center">
                 <div className="w-24 h-24 bg-slate-50 border border-slate-100 rounded-3xl flex items-center justify-center text-4xl font-black text-brand-900 mb-8 mx-auto group-hover:bg-brand-900 group-hover:text-accent transition-all duration-300 transform group-hover:-translate-y-2">
                   {step.id}
                 </div>
                 <h4 className="text-xl font-bold text-brand-900 mb-4 tracking-tight leading-tight">{step.title}</h4>
                 <p className="text-slate-500 font-medium text-sm leading-relaxed italic">{step.desc}</p>
               </div>
             ))}
           </div>
        </div>
      ...
      {/* 11. Secteurs proches de Sèvres */}
      <section className="py-24 bg-slate-50 font-display">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row gap-20 items-end mb-16 px-4">
            <div className="lg:w-2/3">
              <span className="text-accent uppercase font-black tracking-widest text-xs mb-4 block italic">Réseau Local</span>
              <h2 className="text-4xl md:text-5xl font-black text-brand-900 tracking-tight leading-tight italic">Secteurs proches de Sèvres</h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed mt-6 italic">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 px-4 font-display">
            {[
              ...
              { name: "Paris 16e", link: "/demenagement-paris-16" },
          ...
          <div className="bg-white rounded-[4rem] p-12 md:p-24 shadow-2xl border border-slate-50 text-center relative overflow-hidden group">
            ...
            <div className="max-w-4xl mx-auto space-y-10 relative z-10">
              <h2 className="text-3xl md:text-6xl font-black text-brand-900 tracking-tight leading-tight">
                Vous préparez un déménagement à Sèvres ?
              </h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto space-y-12 px-4">
            <div className="text-center mb-16">
               <span className="text-accent uppercase font-black tracking-widest text-xs italic block mb-4">Questions fréquentes</span>
               <h2 className="text-4xl md:text-5xl font-black text-brand-900 tracking-tight mb-4">FAQ Déménagement Sèvres</h2>
               <p className="text-slate-500 font-medium italic">Retrouvez les réponses aux questions les plus courantes pour préparer votre projet à Sèvres.</p>
            </div>
      ...
      <section className="py-20 bg-brand-900 text-white border-t border-white/5 font-display">
        <div className="container mx-auto px-4 md:px-6">
           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 font-display">
             <div className="space-y-6">
                <h4 className="text-accent text-[10px] uppercase font-black tracking-widest italic tracking-[0.2em]">Nos Services</h4>
             ...
             <div className="space-y-6">
                <h4 className="text-accent text-[10px] uppercase font-black tracking-widest italic tracking-[0.2em]">Outils Métiers</h4>
                <ul className="space-y-4">
             ...
             <div className="space-y-6">
                <h4 className="text-accent text-[10px] uppercase font-black tracking-widest italic tracking-[0.2em]">Zones & Secteurs</h4>
                <ul className="space-y-4">
             ...
             <div className="space-y-6">
                <h4 className="text-accent text-[10px] uppercase font-black tracking-widest italic tracking-[0.2em]">Expertise Sèvres</h4>
                <ul className="space-y-4">
      ...
      <div className="sr-only">
        <p>
          Marne Transdem, spécialiste du déménagement Sèvres et dans les Hauts-de-Seine (92), vous propose des prestations sur mesure : transfert de bureaux Sèvres, déménagement appartement, maison, location monte-meuble et garde-meuble. Devis gratuit pour particuliers et professionnels. Proximité Saint-Cloud, Meudon, Boulogne-Billancourt, Paris 16e.
        </p>
      </div>
    </div>
  );
