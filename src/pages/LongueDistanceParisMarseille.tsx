...
const LongueDistanceParisMarseille: React.FC = () => {
  const path = "/demenagement-paris-marseille";
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO 
        title="Déménagement Paris Marseille | Marne Transdem"
        description="Organisez votre déménagement de Paris vers Marseille avec Marne Transdem. Volume, emballage, transport longue distance, formules adaptées et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
            ...
            { name: "Paris Marseille", item: path }
          ])
        ]}
      />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-[1.1] tracking-tight italic">
              Paris <span className="text-accent italic">Marseille</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed font-light max-w-3xl italic font-sans font-medium">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement depuis Paris ou l’Île-de-France vers Marseille, avec une organisation adaptée à la distance.
            </p>

            <div className="flex flex-col sm:flex-row gap-5">
              <Link to="/demande-de-devis" className="bg-accent text-brand-900 px-10 py-5 rounded-full font-bold text-lg hover:bg-accent-hover shadow-xl flex items-center justify-center gap-3 group transition-all italic tracking-tight decoration-brand-900/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/10 underline-offset-8">
                Préparer un déménagement <br/><span className="text-accent italic">de Paris vers Marseille</span>
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic">
                <p>
                  Un déménagement entre Paris et Marseille demande une organisation précise, car il s’agit d’un trajet longue distance nécessitant une bonne préparation. Marne Transdem accompagne votre <span className="font-bold text-brand-900 italic tracking-tight">départ depuis Paris</span> ou l’Île-de-France pour une installation sereine à <span className="font-bold text-brand-900 italic tracking-tight italic">Marseille</span>.
                </p>
                <p>
      ...
      {/* 3. Section “Pourquoi un déménagement Paris Marseille demande une bonne organisation” */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
            <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 mb-6">Logistique <span className="text-accent italic tracking-tight italic">Grand Axe Sud</span></h2>
            <p className="text-slate-500 text-lg font-light italic max-w-3xl mx-auto italic font-sans italic">
              La distance importante entre les deux adresses impose une préparation rigoureuse des protections et une coordination parfaite du planning.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 italic font-sans">
            {[
              { icon: Truck, t: "800 km sécurisés", d: "Gestion rigoureuse du trajet sur l'axe A7 pour assurer l'acheminement de vos biens en toute sécurité." },
              { icon: Package, t: "Objets fragiles", d: "Emballage spécifique et protection renforcée pour les meubles et effets sensibles sur longue distance." },
              { icon: Ruler, t: "Accès & Étages", d: "Anticipation des contraintes au départ (Paris/IDF) et à l'arrivée (Marseille) pour une manutention fluide." },
              { icon: Calculator, t: "Estimation Volume", d: "Étude précise de la capacité de chargement nécessaire via notre calculateur de volume dédié." },
              { icon: Calendar, t: "Planning Maîtrisé", d: "Coordination des dates de chargement et de livraison pour une transition sereine vers le Sud." },
              { icon: ClipboardCheck, t: "Organisation Pro", d: "Une méthode éprouvée pour les transferts de particuliers et d'entreprises vers Marseille." }
            ].map((item, i) => (
      ...
      {/* 4. Nos services pour votre déménagement Paris Marseille */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8">
           <h2 className="text-3xl md:text-5xl font-black text-brand-900 uppercase italic tracking-tight underline italic">Services <span className="text-accent italic tracking-tight italic underline italic underline-offset-4">sur-mesure</span></h2>
        </div>
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 italic">
          {[
            { t: "Particuliers", d: "Accompagnement des familles quittant l’Île-de-France pour s’installer à Marseille.", l: "/demenagement-particuliers-paris" },
            { t: "Entreprises", d: "Transferts professionnels et bureaux de Paris vers la cité phocéenne.", l: "/demenagement-entreprises-paris" },
      ...
      {/* 5. Déménagement Paris Marseille pour les particuliers */}
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center italic">
            ...
            <div className="lg:w-1/2 space-y-8 order-1 lg:order-2 italic font-sans italic">
              ...
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic italic">
                <p>
                  Marne Transdem accompagne les particuliers pour leurs projets de mutation, changement de résidence ou <span className="font-bold text-slate-700 tracking-tight italic tracking-tight">installation à Marseille</span>.
                </p>
                <p>
                   Qu'il s'agisse d'un <span className="font-bold text-slate-700 tracking-tight italic text-slate-700">appartement</span>, d'une <span className="font-bold text-slate-700 tracking-tight italic">maison</span> en bord de mer ou d'un studio, nous gérons le transport depuis l’Île-de-France avec une attention particulière aux <span className="font-bold text-slate-700 tracking-tight italic font-bold">meubles</span> et objets fragiles. Nous vous aidons à choisir la formule adaptée à votre budget et vos besoins.
                </p>
              </div>
              <Link to="/demande-de-devis" className="inline-flex items-center gap-3 bg-brand-900 text-white px-10 py-5 rounded-full font-bold hover:bg-accent hover:text-brand-900 transition-all shadow-xl italic tracking-tight italic h-full transition-all italic">
                Demander mon devis Paris Marseille <ArrowRight size={18} />
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* 6. Déménagement Paris Marseille pour les entreprises */}
      <section className="py-24 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-20 items-center italic">
             ...
             <div className="lg:w-1/2 space-y-8 italic font-sans italic italic">
               ...
               <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic italic italic">
                 <p>
                   Notre expertise s'adresse aux bureaux, agences et cabinets souhaitant opérer un <span className="font-bold text-brand-900 italic tracking-tight">transfert professionnel</span> entre Paris/IDF et Marseille.
                 </p>
                 <p>
                    Transfert sécurisé du mobilier de bureau, des <span className="font-bold text-slate-700 tracking-tight italic text-slate-700 font-bold italic">archives</span> et du matériel informatique avec une coordination stricte du planning pour assurer la <span className="font-bold text-brand-900 italic tracking-tight font-bold italic">continuité d'activité</span> malgré la distance.
                 </p>
               </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic text-center">
          <div className="mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic font-sans italic underline underline-offset-8 italic underline transition-all">
            <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 transition-all font-sans italic font-display">Point de départ <span className="text-accent italic tracking-tight italic italic underline italic underline-offset-4 italic">Paris/IDF</span></h2>
          </div>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-6 text-[10px] font-black uppercase tracking-[0.25em] text-slate-400 italic font-sans italic italic italic transition-colors transition-all">
             ...
             <Link to="/demenagement-ile-de-france" className="hover:text-brand-900 border-b border-accent/20 italic italic transition-all italic transition-all italic">Île-de-France Global</Link>
          </div>
        </div>
      </section>

      {/* 8. Arrivée à Marseille */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center italic transition-all italic grayscale-[0%] transition-all">
             <div className="space-y-8 italic transition-all transition-all italic transition-all">
               ...
               <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed italic italic italic italic transition-all italic italic transition-all italic transition-all italic transition-all italic">
                 <p>
                   L’arrivée à <span className="text-white font-bold italic tracking-tight transition-all">Marseille</span> doit être anticipée selon la configuration de votre nouvelle adresse. Chaque projet fait l'objet d'une étude selon le type de logement et les accès.
                 </p>
                 <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 italic font-sans italic italic transition-all italic transition-all italic transition-all transition-all italic transition-all">
                    {[
                      "Appartement ou maison", "Étage & Ascenseur", "Accès Cage d'Escalier", "Stationnement autorisé", "Meubles Volumineux", "Option Monte-meuble"
                    ].map((item, i) => (
             ...
             <div className="bg-white/5 rounded-[3.5rem] p-12 lg:p-20 border border-white/10 backdrop-blur-md shadow-2xl space-y-8 italic font-sans italic transition-all italic transition-all transition-all italic transition-all italic font-sans italic transition-all h-full">
                <Info className="text-accent mb-4 grayscale-[20%] transition-all italic transition-all italic" size={32} />
                <p className="text-slate-300 italic font-light italic leading-relaxed text-sm italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
                  Marne Transdem accompagne votre installation phocéenne avec rigueur. La faisabilité d'un monte-meuble dépendra de la configuration technique constatée à l'arrivée (balcon, rue étroite, accès).
                </p>
             </div>
          </div>
        </div>
      ...
      {/* 9. Formules adaptées à un déménagement Paris Marseille */}
      <section className="py-24 bg-slate-50 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center mb-16 italic font-sans underline underline-offset-8 decoration-accent/20 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
          <h2 className="text-3xl md:text-5xl font-black text-brand-900 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 italic transition-all italic font-sans italic transition-all italic transition-all">Formules Paris Marseille</h2>
        </div>
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
          {[
            { n: "Économique", d: "Manutention et transport sécurisé sur 800km. Vous assurez la préparation intégrale de vos cartons." },
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all italic font-sans italic transition-all italic transition-all italic">
           <div className="max-w-4xl mx-auto space-y-12 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all">
             ...
             <p className="text-slate-500 text-lg font-light leading-relaxed italic italic italic italic italic transition-all italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
                Le devis pour votre déménagement <span className="font-bold text-brand-900 italic tracking-tight">Paris Marseille</span> dépend notamment de l'étude rigoureuse du volume, des adresses et de la formule choisie.
             </p>
      ...
      <section className="py-24 bg-brand-900 text-white font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 text-center italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          <h2 className="text-3xl md:text-6xl font-black text-white tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 transition-all italic underline italic italic transition-all underline-offset-8 decoration-accent/10 transition-all font-sans italic transition-all">ÉTAPE 1 : LE VOLUME</h2>
          <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto italic font-light italic leading-relaxed italic italic italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all transition-all">
            Avant de solliciter votre devis personnalisé Paris Marseille, utilisez notre calculateur de volume. Cette estimation indicative sera affinée selon les accès et les caractéristiques de votre projet.
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 text-center italic font-sans transition-all italic transition-all transition-all italic h-full transition-all">
            {[
              ...
              { icon: Truck, t: "Transport", d: "Acheminement sécurisé vers Marseille." },
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic transition-all font-sans italic transition-all italic transition-all italic">
          <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
             <h2 className="text-2xl md:text-4xl font-black text-brand-900 uppercase italic tracking-tight underline decoration-accent/20 underline-offset-8 transition-all font-sans italic">Villes <span className="text-accent italic tracking-tight italic italic underline italic underline-offset-4 italic font-display">desservies</span></h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 italic font-sans transition-all italic">
            {[
          ...
          <div className="text-center mt-12 italic transition-all">
      ...
      <section className="py-24 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic">
           <div className="text-center mb-16 italic font-sans underline decoration-accent/10 underline-offset-8 italic transition-all italic font-sans italic transition-all underline underline-offset-8 italic transition-all">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-4 font-display uppercase italic tracking-tight transition-all font-sans italic underline decoration-accent/20 underline-offset-[12px] italic transition-all underline">FAQ PARIS MARSEILLE</h2>
           </div>
      ...
      <section className="py-12 bg-slate-900 font-sans italic transition-all">
        <div className="container mx-auto px-4 md:px-6 italic font-sans italic italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-4 text-[8px] font-black uppercase tracking-[0.15em] text-slate-700 italic pt-8 font-sans italic italic transition-colors transition-all italic transition-all italic transition-all italic transition-all italic transition-all underline decoration-accent/10 transition-all font-sans italic transition-all italic transition-all italic transition-all italic transition-all italic transition-all italic selection:bg-accent italic">
            ...
            <Link to="/demenagement-montreuil" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Montreuil</Link>
            <Link to="/demenagement-vincennes" className="hover:text-accent uppercase italic transition-all font-sans italic transition-all">Vincennes</Link>
...
export default LongueDistanceParisMarseille;
