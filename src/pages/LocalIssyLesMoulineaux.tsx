...
const LocalIssyLesMoulineaux: React.FC = () => {
  const path = "/demenagement-issy-les-moulineaux";
  ...
  return (
    <div className="bg-white text-slate-900 overflow-x-hidden">
      <SEO 
        title="Déménagement Issy-les-Moulineaux | Marne Transdem"
        description="Préparez votre déménagement à Issy-les-Moulineaux avec Marne Transdem. Services pour particuliers et entreprises, formules adaptées, monte-meuble, garde-meuble et devis personnalisé."
        canonical={path}
        schema={[
          getFAQSchema(faqs),
          getBreadcrumbSchema([
            ...
            { name: "Déménagement Issy-les-Moulineaux", item: path }
          ])
        ]}
      />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            <nav className="flex items-center gap-2 mb-8 text-[10px] font-black uppercase tracking-widest text-slate-400">
              ...
              <span>/</span>
              <span className="text-accent underline decoration-accent/20 underline-offset-4 font-black">Issy-les-Moulineaux</span>
            </nav>
            ...
            <p className="text-lg md:text-2xl text-slate-500 mb-12 leading-relaxed font-light max-w-2xl italic">
              Marne Transdem accompagne les particuliers et les entreprises dans leurs projets de déménagement à Issy-les-Moulineaux, avec une organisation adaptée aux appartements, résidences, bureaux, commerces et contraintes d’accès du sud-ouest parisien.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <div className="inline-block px-4 py-1.5 bg-brand-900/5 rounded-full">
                <span className="text-[10px] font-black uppercase tracking-widest text-brand-900 italic">Dynamisme & Proximité</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8">
                Votre déménagement à Issy-les-Moulineaux
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic">
                <p>
                  Ville dynamique des <span className="font-bold text-slate-700">Hauts-de-Seine</span>, Issy-les-Moulineaux se distingue par sa transformation urbaine et son attractivité économique. Marne Transdem accompagne les <span className="font-bold text-slate-700">particuliers</span> et les <span className="font-bold text-slate-700">entreprises</span> dans leurs projets de déménagement. Notre proximité immédiate avec <span className="font-bold text-slate-700">Paris 15e</span> et <span className="font-bold text-slate-700">Boulogne-Billancourt</span> nous permet d'intervenir avec réactivité dans tout le sud-ouest parisien.
                </p>
                <p>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mb-20 text-center mx-auto text-white">
            ...
            <p className="text-slate-400 text-lg font-light leading-relaxed italic">
              La densité d'Issy-les-Moulineaux et ses immeubles de bureaux imposent une organisation rigoureuse.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white">
            {[
              { 
                title: "Ville Dense & Proche Paris", 
                desc: "Une logistique adaptée aux flux de circulation et aux zones d'activités tertiaires intenses.",
                icon: Building2 
              },
              { 
                title: "Résidentiel & Apparts", 
                desc: "Gestion des accès en étages, ascenseurs et protection des parties communes des immeubles récents.",
                icon: Box 
              },
              { 
                title: "Entreprises & Bureaux", 
                desc: "Transfert méthodique de sièges sociaux, agences et cabinets avec maintien de l'activité.",
                icon: ShieldCheck 
              },
              { 
                title: "Meubles & Fragiles", 
                desc: "Emballage spécifique et protection renforcée pour le mobilier volumineux et les objets d'art.",
                icon: MapPin 
              },
              { 
              ...
              { 
                title: "Stationnement & Planning", 
                desc: "Anticipation des zones de chargement et respect strict du planning d'intervention.",
                icon: Package 
              }
            ].map((item, i) => (
              <div key={i} className="bg-white/5 border border-white/10 p-10 rounded-[3rem] backdrop-blur-sm group hover:border-accent transition-all text-white">
                ...
                <h3 className="text-xl font-bold mb-4 text-white group-hover:text-accent transition-colors font-display italic">{item.title}</h3>
      ...
      <section className="py-24 font-display">
        <div className="container mx-auto px-4 md:px-6 text-slate-900">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 italic">Nos services à Issy-les-Moulineaux</h2>
            <p className="text-slate-500 font-light text-lg italic">Des solutions expertes pour chaque type de déménagement.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: "Déménagement Entreprises", path: "/demenagement-entreprises-paris", desc: "Bureaux, cabinets, commerces, agences et professions libérales." },
        ...
        <div className="container mx-auto px-4 md:px-6 text-slate-900">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8 font-display">
              <h2 className="text-3xl md:text-5xl font-black text-brand-900 leading-tight tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8">
                Déménagement d’entreprises à Issy
              </h2>
              <div className="space-y-6 text-slate-500 text-lg font-light leading-relaxed italic font-display">
                <p>
                  Issy-les-Moulineaux est un pôle d'innovation majeur. Nous accompagnons les professionnels pour leurs transferts de bureaux, sièges sociaux, cabinets et agences. De la gestion du <span className="font-bold text-slate-700">mobilier professionnel</span> aux <span className="font-bold text-slate-700">archives</span> et au <span className="font-bold text-slate-700">matériel informatique</span>, nous assurons une logistique rigoureuse pour votre <span className="font-bold text-slate-700">continuité d'activité</span>.
                </p>
                <p>
                  Notre proximité avec <span className="font-bold text-slate-700">Paris 15e</span>, <span className="font-bold text-slate-700">Boulogne-Billancourt</span>, <span className="font-bold text-slate-700">Vanves</span> et <span className="font-bold text-slate-700">Meudon</span> nous permet d'organiser des transferts fluides avec un <span className="font-bold text-slate-700">planning</span> maîtrisé. Nous gérons les accès et proposons du <span className="font-bold text-slate-700">stockage temporaire</span> si besoin pour votre matériel et cartons professionnels.
                </p>
              </div>
              <Link 
      ...
      <section className="py-24 bg-slate-50 font-display">
        <div className="container mx-auto px-4 md:px-6 text-slate-900">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-lg font-light italic">Trois niveaux d'accompagnement pour correspondre à vos attentes.</p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-brand-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="max-w-4xl relative z-10 text-white font-display">
              <h2 className="text-3xl md:text-5xl font-black mb-10 tracking-tight uppercase italic underline decoration-accent/20 underline-offset-8 text-white">Volume, accès et monte-meuble à Issy</h2>
              <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed mb-12 italic font-display">
                <p>
                  Certains déménagements à Issy-les-Moulineaux imposent une étude logistique attentive. L'urbanisme moderne ou haussmannien de la ville, avec ses <span className="text-white font-medium">immeubles résidentiels</span>, ses <span className="text-white font-medium">sièges sociaux</span> et ses rues fréquentées, exige d'anticiper la manutention.
                </p>
                <p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-white rounded-[3rem] shadow-xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 border border-slate-100 font-display">
            <div className="max-w-xl text-center md:text-left font-display">
              <h2 className="text-3xl md:text-4xl font-black text-brand-900 mb-6 leading-tight italic">Estimez le volume de votre déménagement</h2>
      ...
      <section className="py-24 font-display text-slate-900">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-20 text-slate-900">
            ...
            <p className="text-slate-500 text-lg font-light italic font-display">Un processus clair pour préparer votre déménagement à Issy-les-Moulineaux en toute tranquillité.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 font-display">
            {[
              { title: "Analyse de votre projet", icon: ClipboardCheck, desc: "Définition de vos besoins, dates et spécificités locales." },
      ...
      <section className="py-24 border-t border-slate-100 bg-slate-50 font-display">
        <div className="container mx-auto px-4 md:px-6 text-slate-900 text-center">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-black text-brand-900 font-display italic underline decoration-accent/20 underline-offset-8 uppercase">Autres secteurs proches</h2>
          </div>
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-6 text-center text-slate-500 font-display">
            <Link to="/demenagement-paris-15" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display italic">Déménagement Paris 15e</Link>
            <Link to="/demenagement-boulogne-billancourt" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display italic">Déménagement Boulogne-Billancourt</Link>
            <Link to="/demenagement-hauts-de-seine" className="text-slate-400 hover:text-accent font-bold text-sm transition-colors border-b border-transparent hover:border-accent font-display italic">Déménagement Hauts-de-Seine</Link>
            ...
            <span className="text-slate-300 font-bold text-sm italic font-display">Déménagement Montrouge</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-accent relative overflow-hidden font-display text-brand-900">
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10 font-display text-brand-900">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight font-display italic underline decoration-brand-900/20 underline-offset-8 uppercase">Vous préparez un déménagement à Issy-les-Moulineaux ?</h2>
      ...
      <section className="py-24 font-display">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-slate-900 font-display">
          <div className="text-center mb-16 text-slate-900 font-display">
            <h2 className="text-3xl md:text-5xl font-black text-brand-900 mb-6 uppercase italic underline decoration-accent/20 underline-offset-8 font-display">FAQ Issy-les-Moulineaux</h2>
            <p className="text-slate-500 font-light italic font-display italic">Nos réponses pour préparer votre projet sereinement dans le sud-ouest parisien.</p>
          </div>

          <div className="space-y-6 font-display">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-slate-50 p-10 rounded-[2rem] border border-slate-200 font-display">
                <h4 className="text-lg font-bold text-brand-900 mb-6 flex items-start gap-4 font-display text-brand-900 uppercase italic">
                  <HelpCircle className="text-accent shrink-0 mt-1 font-display font-display text-accent" size={22} />
                  {faq.q}
                </h4>
        ...
        <div className="container mx-auto px-4 md:px-6 text-slate-900 font-display">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 font-display">
            <div className="space-y-4 font-display">
              <h5 className="text-[10px] font-black uppercase tracking-widest text-brand-900/30 font-display italic uppercase">Accès Rapide</h5>
            ...
            <div className="space-y-4 col-span-2 font-display">
              ...
              <ul className="space-y-2 text-sm italic font-display">
                <li><Link to="/contact" className="text-slate-500 hover:text-accent transition-colors font-display italic">Marne Transdem Paris</Link></li>
...
export default LocalIssyLesMoulineaux;
