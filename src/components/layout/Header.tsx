        ...
        {isOpen && (
          <>
            ...
            <motion.div 
              ...
              className="lg:hidden fixed top-0 right-0 bottom-0 w-[85%] max-w-sm bg-white z-[70] shadow-2xl flex flex-col p-10 pt-24"
            >
              <button 
                        ...
                        {hasSubmenu ? (
                          <button 
                            ...
                            className={`w-full flex items-center justify-between text-2xl font-bold transition-all ${
                              location.pathname.startsWith(item.path) ? 'text-accent pl-4 border-l-4 border-accent' : 'text-brand-900'
                            }`}
                          >
                            {item.name}
                        ...
                        {hasSubmenu && (
                          <AnimatePresence>
                            {isExpanded && (
                              ...
                              >
                                <div className="mt-4 ml-4 flex flex-col gap-3 border-l border-slate-100 pl-4 pb-2">
                                  {(
                                    item.name === 'Services' ? OTHER_SERVICES : 
                                    item.name === 'Particuliers' ? INDIVIDUAL_SERVICES : 
                                    PRO_SERVICES
                                    ...
                                    <Link 
                                      ...
                                      to={s.path} 
                                      onClick={closeMenu}
                                      className="text-base font-medium text-slate-500 hover:text-accent transition-colors flex items-center gap-3 py-1"
                                    >
                                      <div className="bg-slate-100 p-1.5 rounded-lg text-brand-900">
                                        <s.icon size={16} />
                                      </div>
                                      {s.title}
                                    </Link>
                                  ...
                                  <Link 
                                    to={item.path} 
                                    onClick={closeMenu}
                                    className="text-sm font-bold text-accent hover:text-brand-900 transition-colors flex items-center gap-2 uppercase tracking-widest mt-2"
                                  >
