...
export const ServicesSection = () => (
  <section id="services-accueil" aria-labelledby="home-services-heading" className="home-service-directory">
    <div className="container mx-auto px-4 md:px-6">
      <div className="home-service-layout">
        <div className="home-service-intro">
          ...
          <h2 id="home-services-heading">Les solutions pour <span>préparer votre déménagement</span></h2>
        ...
        <div className="home-service-list">
          {SERVICES.filter(service => ['garde-meuble', 'monte-meuble', 'emballage', 'cartons', 'petit-volume', 'piano'].includes(service.id)).map(service => (
            <article key={service.id} className="home-service-row">
              <div className="home-service-icon"><service.icon size={24} aria-hidden="true" /></div>
