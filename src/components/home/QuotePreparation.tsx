...
export function QuotePreparation() {
  return (
    <section id="preparer-votre-devis" aria-labelledby="home-quote-heading" className="home-preparation py-16 md:py-24 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 md:px-6">
        <div className="home-preparation-layout grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          <div className="home-preparation-copy">
            <p className="home-preparation-eyebrow">Un devis adapté à votre réalité</p>
            <h2 id="home-quote-heading" className="text-3xl md:text-4xl font-bold text-brand-900 dark:text-white mb-6">Votre devis de déménagement <span>à Paris et en Île-de-France</span></h2>
          ...
          <ol className="home-preparation-steps" role="list">
            <li className="border-b border-slate-200 dark:border-slate-700 pb-6"><h3 className="text-xl font-bold text-brand-900 dark:text-white mb-2"><span className="home-preparation-number">1.</span> Décrire le trajet et les accès</h3><p className="text-slate-600 dark:text-slate-300 leading-relaxed">Précisez les villes de départ et d’arrivée, la date envisagée, les étages et les ascenseurs. Signalez les difficultés de stationnement ou de passage des meubles.</p></li>
            <li className="border-b border-slate-200 dark:border-slate-700 pb-6"><h3 className="text-xl font-bold text-brand-900 dark:text-white mb-2"><span className="home-preparation-number">2.</span> Estimer les biens à transporter</h3><p className="text-slate-600 dark:text-slate-300 leading-relaxed">Recensez meubles, cartons et objets particuliers. Utilisez notre <Link to="/calculateur-volume" className="underline underline-offset-4 font-semibold">calculateur de volume en m³</Link> pour préparer une première estimation.</p></li>
            <li><h3 className="text-xl font-bold text-brand-900 dark:text-white mb-2"><span className="home-preparation-number">3.</span> Choisir votre accompagnement</h3><p className="text-slate-600 dark:text-slate-300 leading-relaxed">Comparez les <Link to="/formules-demenagement" className="underline underline-offset-4 font-semibold">formules de déménagement</Link> et indiquez vos besoins d’emballage, de démontage ou de stockage. Les prestations retenues doivent figurer dans votre devis.</p></li>
          </ol>
        </div>
      </div>
    </section>
