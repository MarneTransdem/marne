...
const FicheIncidentPdfDocument = ({ data, logoUrl }) => {
    const incNo = `INC-${(data.id || '').replace('DEM-', '')}`;
    const date = data.date || 'Non programmée';
    const assignedTruck = data.assignedTruck || 'Fourgon VL 20m³';
    return ((0, jsx_runtime_1.jsx)(renderer_1.Document, { children: (0, jsx_runtime_1.jsxs)(renderer_1.Page, { size: "A4", style: pdfStyles.page, children: [(0, jsx_runtime_1.jsxs)(renderer_1.View, { children: [(0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.header, children: [(0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.logoContainer, children: [(0, jsx_runtime_1.jsx)(renderer_1.Image, { src: logoUrl, style: { width: 120, height: 35, objectFit: 'contain' } }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: pdfStyles.slogan, children: "D\u00E9m\u00E9nagez en toute s\u00E9r\u00E9nit\u00E9 !" })] }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.headerMeta, children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: [pdfStyles.badge, { backgroundColor: '#dc2626' }], children: "Fiche d'Incident / Litiges" }), (0, jsx_runtime_1.jsxs)(renderer_1.Text, { style: pdfStyles.devisNo, children: ["INCIDENT N\u00B0 : ", incNo] }), (0, jsx_runtime_1.jsxs)(renderer_1.Text, { style: pdfStyles.dateText, children: ["Date de mission : ", date] }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: [pdfStyles.dateText, { fontSize: 6.5 }], children: "Rapport de non-conformit\u00E9 & Litiges qualit\u00E9" })] })] }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: { backgroundColor: '#fef2f2', borderWidth: 1, borderColor: '#fee2e2', borderRadius: 8, padding: 10, marginTop: 15 }, children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 7.5, fontWeight: 'bold', color: '#991b1b', textTransform: 'uppercase', marginBottom: 3 }, children: "D\u00C9CLARATION FORMELLE DE CONSTATATIONS CONFLICTUELLES" }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 7, color: '#7f1d1d', lineHeight: 1.3 }, children: "Ce rapport consigne de mani\u00E8re officielle tout incident de livraison, d\u00E9faut de conformit\u00E9 ou d\u00E9gradation constat\u00E9 sur le chantier. Il sert de pi\u00E8ce justificative pour l'instruction du dossier d'assurance AXA." })] }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.addressesGrid, children: [(0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.addressCard, children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: pdfStyles.colTitle, children: "\uD83D\uDC64 IDENTIFICATION CLIENT" }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: { display: 'flex', flexDirection: 'column', gap: 4 }, children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: pdfStyles.clientName, children: data.clientName }), (0, jsx_runtime_1.jsxs)(renderer_1.Text, { style: pdfStyles.addressDetails, children: ["Date de mission : ", date] }), (0, jsx_runtime_1.jsxs)(renderer_1.Text, { style: pdfStyles.addressDetails, children: ["Trajet : ", data.fromCity, " \u2794 ", data.toCity] })] })] }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.addressCard, children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: [pdfStyles.colTitle, { color: '#991b1b' }], children: "\uD83D\uDE9A ENCADREMENT LOGISTIQUE" }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: { display: 'flex', flexDirection: 'column', gap: 4 }, children: [(0, jsx_runtime_1.jsxs)(renderer_1.Text, { style: pdfStyles.addressDetails, children: ["Chef d'\u00E9quipe : ", data.teamLeader] }), (0, jsx_runtime_1.jsxs)(renderer_1.Text, { style: pdfStyles.addressDetails, children: ["V\u00E9hicule impliqu\u00E9 : ", assignedTruck] }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: [pdfStyles.addressDetails, { color: '#dc2626', fontWeight: 'bold' }], children: "Incident signal\u00E9 : OUI" })] })] })] }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: [pdfStyles.sectionTitle, { marginTop: 20 }], children: "\uD83D\uDCCB CONSTATATIONS D\u00C9TAILL\u00C9ES DE L'\u00C9QUIPE (DICT\u00C9E VOCALE IA)" }), (0, jsx_runtime_1.jsx)(renderer_1.View, { style: { borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 8, padding: 10, minHeight: 120, backgroundColor: '#f8fafc' }, children: (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 7.5, color: '#334155', lineHeight: 1.4 }, children: data.notes ? data.notes : "Aucune description détaillée consignée. Rapport généré pour non-conformité contradictoire." }) }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: [pdfStyles.signaturesBlock, { marginTop: 30 }], children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: pdfStyles.sectionTitle, children: "5. VALIDATION & ACCORD DE CONSTATATION CONTRADICTOIRE" }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: pdfStyles.signaturesGrid, children: [(0, jsx_runtime_1.jsxs)(renderer_1.View, { style: [pdfStyles.signatureBox, { width: '48%', height: 80, justifyContent: 'space-between', alignItems: 'stretch' }], children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 7.5, fontWeight: 'bold', color: '#1e293b', borderBottomWidth: 0.5, borderBottomColor: '#cbd5e1', paddingBottom: 2 }, children: "Pour Marne Transdem (Chef d'\u00E9quipe)" }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 6.5, color: '#64748b' }, children: "Je certifie l'exactitude des constatations d'incidents consign\u00E9es ci-dessus." }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 6.5, fontWeight: 'bold', color: '#64748b', textAlign: 'center' }, children: data.teamLeader })] }), (0, jsx_runtime_1.jsxs)(renderer_1.View, { style: [pdfStyles.signatureBox, { width: '48%', height: 80, justifyContent: 'space-between', alignItems: 'stretch' }], children: [(0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 7.5, fontWeight: 'bold', color: '#1e293b', borderBottomWidth: 0.5, borderBottomColor: '#cbd5e1', paddingBottom: 2 }, children: "Pour le Client (Signature)" }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 6.5, color: '#64748b' }, children: "Prise d'acte des constatations contradictoires d'incidents ci-dessus." }), (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: { fontSize: 6.5, fontWeight: 'bold', color: '#64748b', textAlign: 'center' }, children: "Signature Client" })] })] })] })] }), (0, jsx_runtime_1.jsx)(renderer_1.View, { children: (0, jsx_runtime_1.jsx)(renderer_1.Text, { style: pdfStyles.footerPageNum, children: "\u00A9 Marne Transdem Logistique \u2014 Ce document officiel fait foi devant la DREAL et le Tribunal de commerce comp\u00E9tents." }) })] }) }));
};
...
async function generatePdfBuffer(type, data) {
    ...
    if (type === 'devis') {
        ...
        doc = ((0, jsx_runtime_1.jsx)(FicheIncidentPdfDocument, { data: data, logoUrl: logoUrl }));
    }
    else {
